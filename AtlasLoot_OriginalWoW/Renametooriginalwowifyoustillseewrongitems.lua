...
---- Azuregos
	...
	AtlasLoot_Data["Glittermurk"] = {
		...
		{ 2, 99999, "", "=q3=Staff of Motivation", "", "", ""};
		{ 3, 99999, "", "=q3=Gnoll Cuffs", "=ds=#s8#", "", ""};
		{ 4, 99999, "", "=q2=Tarnished Linked Leggings", "", "", ""};
		{ 6, 0, "INV_Box_01", "=q6="..BabbleEpoch["Miner Davod"], ""};
		{ 7, 99999, "", "=q3=Davod´s Lantern", "", "", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Foreman Sprocket"], ""};
		{ 10, 99999, "", "=q3=Heavy Metal Belt", "", "", ""};
		{ 11, 99999, "", "=q3=Throwing ´Saws´", "", "", ""};
		{ 12, 99999, "", "=q3=Shredder Spaulders", "", "", ""};
		{ 13, 99999, "", "=q3=Steel Pickaxe", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Krakken"], ""};
		{ 17, 99999, "", "=q3=Faded Ring of Truestrike", "", "", ""};
		{ 18, 99999, "", "=q3=Sash of Aquatic Gliding", "", "", ""};
		{ 19, 99999, "", "=q3=Deepsea Coral", "", "", ""};
		{ 20, 99999, "", "=q3=Aquablade", "", "", ""};
		{ 22, 0, "INV_Box_01", "=q6="..BabbleEpoch["Prismscale"], ""};
		{ 23, 99999, "", "=q3=Chromatic Wand", "", "", ""};
		{ 24, 99999, "", "=q3=Unknown Stone Tooth", "", "", ""};
		{ 25, 99999, "", "=q3=Warding Scale", "", "", ""};
		{ 26, 99999, "", "=q2=Venturing Bracelets", "", "", ""};
		Next = "Glittermurk2";
	};

	AtlasLoot_Data["Glittermurk2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Murklurk"], ""};
		{ 2, 99999, "", "=q3=Shadowcasters Hood", "", "", ""};
		{ 3, 99999, "", "=q3=Shadow Trousers", "", "", ""};
		{ 4, 99999, "", "=q3=Forgotten Shoulderpads", "", "", ""};
		{ 5, 99999, "", "=q3=Amulet of Brawn", "", "", ""};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleEpoch["Gnash"], ""};
		{ 8, 99999, "", "=q4=Trident of Nazjatar", "", "", ""};
		{ 9, 99999, "", "=q3=Naga Precision", "", "", ""};
		{ 10, 99999, "", "=q3=Crown of Tides", "", "", ""};
		{ 11, 99999, "", "=q3=Encrusted Fetish", "", "", ""};
		{ 12, 99999, "", "=q3=Buckler of Seas", "", "", ""};
		Prev = "Glittermurk";
	};
	...
	AtlasLoot_Data["BaradinHold"] = {
		...
		{ 2, 99999, "", "=q3=Cursed Talisman of Wellbeing", "", "", ""};
		{ 3, 99999, "", "=q3=Talisman of Wellbeing", "", "", ""};
		{ 4, 99999, "", "=q3=Voidhound Cloak", "", "", ""};
		{ 5, 99999, "", "=q3=Cinch of Magical Repel", "", "", ""};
		{ 6, 99999, "", "=q2=Fel Axe", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Dak´mal"], ""};
		{ 17, 99999, "", "=q3=Imp Belt", "", "", ""};
		{ 18, 99999, "", "=q3=Felguard Gauntlets", "", "", ""};
		{ 19, 99999, "", "=q3=Rune Warder´s Mantle", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Orb of Dak´mal", "", "", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Millhouse Manastorm"], ""};
		{ 10, 99999, "", "=q3=Manastorm Wand", "", "", ""};
		{ 11, 99999, "", "=q3=Millhouse´s Bathrobe", "", "", ""};
		{ 12, 99999, "", "=q3=Belt of Conjuring", "", "", ""};
		{ 13, 99999, "", "=q3=Prestidigitation", "", "", ""};
		{ 14, 99999, "", "=q3=Bonzo´s Brass Buttons", "", "", ""};
		{ 24, 0, "INV_Box_01", "=q6="..BabbleEpoch["Glagut"], ""};
		{ 25, 99999, "", "=q2=Recipe: Black Coffee", "", "", ""};
		{ 26, 99999, "", "=q2=Recipe: Seafarer´s Swig", "", "", ""};
		{ 27, 99999, "", "=q3=Girdle of Extreme Duress", "", "", ""};
		Next = "BaradinHold2";
	};

	AtlasLoot_Data["BaradinHold2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Astilos the Hollow"], ""};
		{ 2, 99999, "", "=q3=Rune Warder´s Loins", "", "", ""};
		{ 3, 99999, "", "=q3=Black Mold Shoulderpads", "", "", ""};
		{ 4, 99999, "", "=q3=Coif of Hollowed Memories", "", "", ""};
		{ 5, 99999, "", "=q3=Shadowfrost Scepter", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Nazrasash"], ""};
		{ 17, 99999, "", "=q3=Nazrasash´s Shoulderguards", "", "", ""};
		{ 18, 99999, "", "=q3=Anti-Arcane Sabatons", "", "", ""};
		{ 19, 99999, "", "=q3=Sunderer´s Mastery", "", "", ""};
		{ 20, 99999, "", "=q3=Idol of Highborne Rejection", "", "", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Calypso"], ""};
		{ 10, 99999, "", "=q3=Rune Warder´s Raiment", "", "", ""};
		{ 11, 99999, "", "=q3=Talons of Calypso", "", "", ""};
		{ 12, 99999, "", "=q3=Tough Tail Feathers", "", "", ""};
		{ 24, 0, "INV_Box_01", "=q6="..BabbleEpoch["Pirate Lord Blackstone"], ""};
		{ 25, 99999, "", "=q3=Booty Belt", "", "", ""};
		Next = "Epochset";
		Prev = "BaradinHold";
	};
	...
	AtlasLoot_Data["Blastedlandsod"] = {
		...
		{ 2, 99999, "", "=q3=Lina´s Battlesuit", "=ds="..AL["Achievement"], "Taskmistress Lina"};
		{ 3, 99999, "", "=q3=Loop of Scorched Earth", "=ds="..AL["Achievement"], "Draz'kel"};
		{ 4, 99999, "", "=q3=Shady Shawl", "=ds="..AL["Achievement"], "Kiera the Shade"};
		{ 6, 0, "INV_Box_01", "=q6="..BabbleEpoch["Questrewards of Interest"], ""};
		{ 7, 99999, "", "=q3=Defias Handwraps", "", "", ""};
		{ 8, 99999, "", "=q3=Enmity´s Eye", "", "", ""};
		{ 9, 99999, "", "=q3=Crown of Beasts", "", "", ""};
		{ 10, 99999, "", "=q3=Broken Compass", "", "", ""};
		{ 11, 99999, "", "=q3=Periapt of the Damned", "", "", ""};
		{ 12, 99999, "", "=q0=Shabby Sock", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Random Loot"], ""};
		{ 17, 99999, "", "=q3=Glyph of Negation", "", "", ""};
		{ 18, 99999, "", "=q3=Felstone", "", "", ""};
		{ 19, 99999, "", "=q2=Glyph of Affliction", "", "", ""};
		{ 20, 99999, "", "=q2=Grombolar Soulstone", "", "", ""};
		{ 21, 99999, "", "=q2=Recipe: Suspicious Stew", "", "", ""};
		{ 22, 99999, "", "=q2=Recipe: Felstone Grog", "", "", ""};
		{ 23, 99999, "", "=q1=Suspicious Stew", "", "", ""};
		{ 24, 99999, "", "=q1=Felstone Grog", "", "", ""};
		{ 25, 99999, "", "=q1=Balefire Draught", "", "", ""};
		{ 29, 0, "INV_Box_01", "=q6="..BabbleEpoch["Soulflayer Ghruzokh"], ""};
		{ 30, 99999, "", "=q3=Fallen Warrior´s Breastplate", "", "", ""};
	...
	AtlasLoot_Data["Blastedlandsod2"] = {
		...
		{ 2, 99999, "", "=q3=Corrupted Draenethyst Sphere", "", "", ""};
		{ 3, 99999, "", "=q2=Glyph of Affliction", "", "", ""};
		{ 4, 99999, "", "=q2=Grombolar Soulstone", "", "", ""};
		Prev = "Blastedlandsod";
		Back = "WORLDEVENTMENU";
	};
	...
	AtlasLoot_Data["Gnomeregan1"] = {
		...
		{ 7, 99999, "", "=q2=Strangely Strong Stone Spear", "", "", ""};
		{ 8, 99999, "", "=q2=Trogghide Pants", "", "", ""};
		{ 9, 99999, "", "=q3=Chompers Chomper", "", "", ""};
		{ 10, 99999, "", "=q3=Slippery Sole Sandals", "", "", ""};
	...
	AtlasLoot_Data["RagefireChasm"] = {
		...
		{ 22, 99999, "", "=q2=Bazzalan´s Shroud", "", "", ""};
		{ 23, 99999, "", "=q2=Satyrchain Epaulets", "", "", ""};
	};
	...
	AtlasLoot_Data["RazorfenKraul1"] = {
		...
		{ 6, 99999, "", "=q3=Thorn Spiked Mantle", "", "", ""};
	...
	AtlasLoot_Data["ShadowfangKeep2"] = {
		...
		{ 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Odo the Blindwatcher"], ""};
		{ 9, 6319, "", "=q3=Girdle of the Blindwatcher", "=ds=#s10#, #a2#", "", "57.15%"};
		{ 10, 6318, "", "=q3=Odo's Ley Staff", "=ds=#w9#", "", "29.97%"};
		{ 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Deathsworn Captain"], ""};
		{ 13, 6642, "", "=q3=Phantom Armor", "=ds=#s5#, #a3#", "", "30.49%"};
		{ 14, 6641, "", "=q3=Haunting Blade", "=ds=#h2#, #w10#", "", "58.60%"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Fenrus the Devourer"], ""};
		{ 17, 6340, "", "=q3=Fenrus' Hide", "=ds=#s4#", "", "58.02%"};
		{ 18, 3230, "", "=q3=Black Wolf Bracers", "=ds=#s8#, #a2#", "", "14.76%"};
		...
		{ 24, 24224, "", "=q1=Crate of Bloodforged Ingots", "=ds=#m3#"};
		{ 25, 6895, "", "=q1=Jordan's Smithing Hammer", "=ds=#m3#"};
		{ 26, 6283, "", "=q1=The Book of Ur", "=ds=#m3#"};
	...
	AtlasLoot_Data["TheDeadmines2"] = {
		...
		{ 9, 99999, "", "=q2=Wind-Up Cannon", "=ds=#s14#", "", ""};
		...
		{ 17, 99999, "", "=q3=Emberlicked Greaves", "=ds=#s11#", "", ""};
		{ 18, 99999, "", "=q2=Tinfire Blades", "=ds=#w11#", "", ""};
		{ 19, 99999, "", "=q2=Twinkling Cape", "=ds=#s4#", "", ""};
		{ 20, 99999, "", "=q1=Eternal Ember", "=ds=#m2#", "", ""};
	...
	AtlasLoot_Data["TheStockade"] = {
		...
		{ 18, 99999, "", "=q2=Smuggling Pouch", "=ds=#e1#", "", ""};
	...
	AtlasLoot_Data["UldGrimlok"] = {
		{ 1, 99999, "", "=q3=Marred Uldic Legplates", "", "", ""};
	...
	AtlasLoot_Data["UldArchaedas"] = {
		{ 1, 99999, "", "=q3=Marred Uldic Chestplate", "", "", ""};
	...
	AtlasLoot_Data["VWOWSets77"] = {
		...
		{ 2, 99999, "", "=q2=Marred Uldic Helm", "=ds=#s1#", "", ""};
		{ 3, 99999, "", "=q2=Marred Uldic Shoulderpads", "=ds=#s3#", "", ""};
		{ 4, 99999, "", "=q3=Marred Uldic Chestplate", "=ds=#s5#", "", ""};
		{ 5, 99999, "", "=q3=Marred Uldic Hands", "=ds=#s9#", "", ""};
		{ 6, 99999, "", "=q3=Marred Uldic Legplates", "=ds=#s11#", "", ""};
		{ 7, 99999, "", "=q3=Marred Uldic Sabatons", "=ds=#s12#", "", ""};
		Next = "UldTrash";
		Prev = "UldArchaedas";
	};
	...
	AtlasLoot_Data["UldTrash"] = {
		...
		{ 14, 99999, "", "=q3=Marred Uldic Sabatons", ""};
		{ 15, 99999, "", "=q2=Marred Uldic Shoulderpads", ""};
	...
	AtlasLoot_Data["WailingCaverns2"] = {
		...
		{ 8, 99999, "", "=q3=Emerald Amulet", "=ds=#s2#", "", ""};
	...
	AtlasLoot_Data["Rookiesep1"] = {
		{ 1, 99999, "", "=q2=Rookie´s Hood", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Rookie´s Mantle", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Rookie´s Robe", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Rookie´s Handcloth", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Rookie´s Leggings", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Rookie´s Slippers", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Rookie´s Cloche", "=ds=#a2#", "", ""};
		{ 9, 99999, "", "=q2=Rookie´s Pads", "=ds=#a2#", "", ""};
		{ 10, 99999, "", "=q2=Rookie´s Leather", "=ds=#a2#", "", ""};
		{ 11, 99999, "", "=q2=Rookie´s Mitts", "=ds=#a2#", "", ""};
		{ 12, 99999, "", "=q2=Rookie´s Pantaloons", "=ds=#a2#", "", ""};
		{ 13, 99999, "", "=q2=Rookie´s Bootlets", "=ds=#a2#", "", ""};
		{ 14, 99999, "", "=q2=Rookie´s Armguards", "=ds=#a2#", "", ""};
		{ 15, 99999, "", "=q2=Rookie´s Strap", "=ds=#a2#", "", ""};
		{ 16, 99999, "", "=q2=Rookie´s Coif", "=ds=#a3#", "", ""};
		{ 17, 99999, "", "=q2=Rookie´s Chaindrapes", "=ds=#a3#", "", ""};
		{ 18, 99999, "", "=q2=Rookie´s Links", "=ds=#a3#", "", ""};
		{ 19, 99999, "", "=q2=Rookie´s Demi-gaunts", "=ds=#a3#", "", ""};
		{ 20, 99999, "", "=q2=Rookie´s Leglinks", "=ds=#a3#", "", ""};
		{ 21, 99999, "", "=q2=Rookie´s Bootlinks", "=ds=#a3#", "", ""};
		{ 22, 99999, "", "=q2=Rookie´s Wrists", "=ds=#a3#", "", ""};
		{ 23, 99999, "", "=q2=Rookie´s Buckle", "=ds=#a3#", "", ""};
		Back = "Epochpvp15";
	};

	AtlasLoot_Data["Rookieaep1"] = {
		{ 1, 99999, "", "=q2=Rookie´s Cap", "=ds=#a2#", "", ""};
		{ 2, 99999, "", "=q2=Rookie´s Shoulders", "=ds=#a2#", "", ""};
		{ 3, 99999, "", "=q2=Rookie´s Tunic", "=ds=#a2#", "", ""};
		{ 4, 99999, "", "=q2=Rookie´s Gloves", "=ds=#a2#", "", ""};
		{ 5, 99999, "", "=q2=Rookie´s Pants", "=ds=#a2#", "", ""};
		{ 6, 99999, "", "=q2=Rookie´s Boots", "=ds=#a2#", "", ""};
		{ 7, 99999, "", "=q2=Rookie´s Cuffs", "=ds=#a2#", "", ""};
		{ 8, 99999, "", "=q2=Rookie´s Belt", "=ds=#a2#", "", ""};
		Back = "Epochpvp15";
	};

	AtlasLoot_Data["Rookiestep1"] = {
		{ 1, 99999, "", "=q2=Rookie´s Helm", "=ds=#a3#", "", ""};
		{ 2, 99999, "", "=q2=Rookie´s Shoulderguards", "=ds=#a3#", "", ""};
		{ 3, 99999, "", "=q2=Rookie´s Chainmail", "=ds=#a3#", "", ""};
		{ 4, 99999, "", "=q2=Rookie´s Handguards", "=ds=#a3#", "", ""};
		{ 5, 99999, "", "=q2=Rookie´s Legguards", "=ds=#a3#", "", ""};
		{ 6, 99999, "", "=q2=Rookie´s Treads", "=ds=#a3#", "", ""};
		{ 7, 99999, "", "=q2=Rookie´s Bracers", "=ds=#a3#", "", ""};
		{ 8, 99999, "", "=q2=Rookie´s Cinch", "=ds=#a3#", "", ""};
		Back = "Epochpvp15";
	};

	AtlasLoot_Data["Skirmishsep1"] = {
		{ 1, 99999, "", "=q2=Skirmisher´s Hood", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Skirmisher´s Mantle", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Skirmisher´s Robe", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Skirmisher´s Handcloth", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Skirmisher´s Leggings", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Skirmisher´s Slippers", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Skirmisher´s Wristwraps", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Skirmisher´s Waistband", "=ds=#a1#", "", ""};
		{ 16, 99999, "", "=q2=Skirmisher´s Cloche", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Skirmisher´s Pads", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Skirmisher´s Leather", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Skirmisher´s Mitts", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Skirmisher´s Pantaloons", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Skirmisher´s Riders", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Skirmisher´s Armguards", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Skirmisher´s Strap", "=ds=#a2#", "", ""};
		{ 12, 99999, "", "=q2=Skirmisher´s Coif", "=ds=#a3#", "", ""};
		{ 13, 99999, "", "=q2=Skirmisher´s Chaindrapes", "=ds=#a3#", "", ""};
		{ 14, 99999, "", "=q2=Skirmisher´s Links", "=ds=#a3#", "", ""};
		{ 15, 99999, "", "=q2=Skirmisher´s Demi-gaunts", "=ds=#a3#", "", ""};
		{ 27, 99999, "", "=q2=Skirmisher´s Leglinks", "=ds=#a3#", "", ""};
		{ 28, 99999, "", "=q2=Skirmisher´s Bootlinks", "=ds=#a3#", "", ""};
		{ 29, 99999, "", "=q2=Skirmisher´s Wrists", "=ds=#a3#", "", ""};
		{ 30, 99999, "", "=q2=Skirmisher´s Buckle", "=ds=#a3#", "", ""};
		Back = "Epochpvp25";
	};

	AtlasLoot_Data["Skirmishhep1"] = {
		{ 1, 99999, "", "=q2=Skirmisher´s Cowl", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Skirmisher´s Stole", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Skirmisher´s Raiment", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Skirmisher´s Hands", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Skirmisher´s Legwarmers", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Skirmisher´s Bootlets", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Skirmisher´s Braceletts", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Skirmisher´s Sash", "=ds=#a1#", "", ""};
		{ 16, 99999, "", "=q2=Skirmisher´s Casque", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Skirmisher´s Rerebrace", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Skirmisher´s Cuirass", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Skirmisher´s Palms", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Skirmisher´s Breeches", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Skirmisher´s Soles", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Skirmisher´s Leather Cuffs", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Skirmisher´s Leather Belt", "=ds=#a2#", "", ""};
		{ 12, 99999, "", "=q2=Skirmisher´s Chain Cloche", "=ds=#a3#", "", ""};
		{ 13, 99999, "", "=q2=Skirmisher´s Light Pauldrons", "=ds=#a3#", "", ""};
		{ 14, 99999, "", "=q2=Skirmisher´s Hauberk", "=ds=#a3#", "", ""};
		{ 15, 99999, "", "=q2=Skirmisher´s Grips", "=ds=#a3#", "", ""};
		{ 27, 99999, "", "=q2=Skirmisher´s Kilt", "=ds=#a3#", "", ""};
		{ 28, 99999, "", "=q2=Skirmisher´s Stompers", "=ds=#a3#", "", ""};
		{ 29, 99999, "", "=q2=Skirmisher´s Manacles", "=ds=#a3#", "", ""};
		{ 30, 99999, "", "=q2=Skirmisher´s Chain", "=ds=#a3#", "", ""};
		Back = "Epochpvp25";
	};

	AtlasLoot_Data["Skirmishaep1"] = {
		{ 1, 99999, "", "=q2=Skirmisher´s Cap", "=ds=#a2#", "", ""};
		{ 2, 99999, "", "=q2=Skirmisher´s Shoulders", "=ds=#a2#", "", ""};
		{ 3, 99999, "", "=q2=Skirmisher´s Tunic", "=ds=#a2#", "", ""};
		{ 4, 99999, "", "=q2=Skirmisher´s Gloves", "=ds=#a2#", "", ""};
		{ 5, 99999, "", "=q2=Skirmisher´s Pants", "=ds=#a2#", "", ""};
		{ 6, 99999, "", "=q2=Skirmisher´s Boots", "=ds=#a2#", "", ""};
		{ 7, 99999, "", "=q2=Skirmisher´s Cuffs", "=ds=#a2#", "", ""};
		{ 8, 99999, "", "=q2=Skirmisher´s Belt", "=ds=#a2#", "", ""};
		Back = "Epochpvp25";
	};

	AtlasLoot_Data["Skirmishstep1"] = {
		{ 1, 99999, "", "=q2=Skirmisher´s Helm", "=ds=#a3#", "", ""};
		{ 2, 99999, "", "=q2=Skirmisher´s Shoulderguards", "=ds=#a3#", "", ""};
		{ 3, 99999, "", "=q2=Skirmisher´s Chainmail", "=ds=#a3#", "", ""};
		{ 4, 99999, "", "=q2=Skirmisher´s Handguards", "=ds=#a3#", "", ""};
		{ 5, 99999, "", "=q2=Skirmisher´s Legguards", "=ds=#a3#", "", ""};
		{ 6, 99999, "", "=q2=Skirmisher´s Treads", "=ds=#a3#", "", ""};
		{ 7, 99999, "", "=q2=Skirmisher´s Bracers", "=ds=#a3#", "", ""};
		{ 8, 99999, "", "=q2=Skirmisher´s Cinch", "=ds=#a3#", "", ""};
		Back = "Epochpvp25";
	};

	AtlasLoot_Data["Combatantsep1"] = {
		{ 1, 99999, "", "=q2=Combatant´s Hood", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Mantle", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Robe", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Handcloth", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Combatant´s Leggings", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Combatant´s Slippers", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Combatant´s Wristwraps", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Combatant´s Waistband", "=ds=#a1#", "", ""};
		{ 16, 99999, "", "=q2=Combatant´s Cloche", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Combatant´s Pads", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Combatant´s Leather", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Combatant´s Mitts", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Combatant´s Pantaloons", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Combatant´s Riders", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Combatant´s Armguards", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Combatant´s Strap", "=ds=#a2#", "", ""};
		{ 12, 99999, "", "=q2=Combatant´s Coif", "=ds=#a3#", "", ""};
		{ 13, 99999, "", "=q2=Combatant´s Chaindrapes", "=ds=#a3#", "", ""};
		{ 14, 99999, "", "=q2=Combatant´s Links", "=ds=#a3#", "", ""};
		{ 15, 99999, "", "=q2=Combatant´s Demi-gaunts", "=ds=#a3#", "", ""};
		{ 27, 99999, "", "=q2=Combatant´s Leglinks", "=ds=#a3#", "", ""};
		{ 28, 99999, "", "=q2=Combatant´s Bootlinks", "=ds=#a3#", "", ""};
		{ 29, 99999, "", "=q2=Combatant´s Wrists", "=ds=#a3#", "", ""};
		{ 30, 99999, "", "=q2=Combatant´s Buckle", "=ds=#a3#", "", ""};
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Combatanthep1"] = {
		{ 1, 99999, "", "=q2=Combatant´s Cowl", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Stole", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Raiment", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Hands", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Combatant´s Legwarmers", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Combatant´s Bootlets", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Combatant´s Braceletts", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Combatant´s Sash", "=ds=#a1#", "", ""};
		{ 16, 99999, "", "=q2=Combatant´s Casque", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Combatant´s Rerebrace", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Combatant´s Cuirass", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Combatant´s Palms", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Combatant´s Breeches", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Combatant´s Soles", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Combatant´s Leather Cuffs", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Combatant´s Leather Belt", "=ds=#a2#", "", ""};
		{ 12, 99999, "", "=q2=Combatant´s Chain Cloche", "=ds=#a3#", "", ""};
		{ 13, 99999, "", "=q2=Combatant´s Light Pauldrons", "=ds=#a3#", "", ""};
		{ 14, 99999, "", "=q2=Combatant´s Hauberk", "=ds=#a3#", "", ""};
		{ 15, 99999, "", "=q2=Combatant´s Grips", "=ds=#a3#", "", ""};
		{ 27, 99999, "", "=q2=Combatant´s Kilt", "=ds=#a3#", "", ""};
		{ 28, 99999, "", "=q2=Combatant´s Stompers", "=ds=#a3#", "", ""};
		{ 29, 99999, "", "=q2=Combatant´s Manacles", "=ds=#a3#", "", ""};
		{ 30, 99999, "", "=q2=Combatant´s Chain", "=ds=#a3#", "", ""};
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Combatantaep1"] = {
		{ 1, 99999, "", "=q2=Combatant´s Cap", "=ds=#a2#", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Shoulders", "=ds=#a2#", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Tunic", "=ds=#a2#", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Gloves", "=ds=#a2#", "", ""};
		{ 5, 99999, "", "=q2=Combatant´s Pants", "=ds=#a2#", "", ""};
		{ 6, 99999, "", "=q2=Combatant´s Boots", "=ds=#a2#", "", ""};
		{ 7, 99999, "", "=q2=Combatant´s Cuffs", "=ds=#a2#", "", ""};
		{ 8, 99999, "", "=q2=Combatant´s Belt", "=ds=#a2#", "", ""};
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Combatantstep1"] = {
		{ 1, 99999, "", "=q2=Combatant´s Helm", "=ds=#a3#", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Shoulderguards", "=ds=#a3#", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Chainmail", "=ds=#a3#", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Handguards", "=ds=#a3#", "", ""};
		{ 5, 99999, "", "=q2=Combatant´s Legguards", "=ds=#a3#", "", ""};
		{ 6, 99999, "", "=q2=Combatant´s Treads", "=ds=#a3#", "", ""};
		{ 7, 99999, "", "=q2=Combatant´s Bracers", "=ds=#a3#", "", ""};
		{ 8, 99999, "", "=q2=Combatant´s Cinch", "=ds=#a3#", "", ""};
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Aspirantsep1"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Hood", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Mantle", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Robe", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Handcloth", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Leggings", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Slippers", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Wristwraps", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Waistband", "=ds=#a1#", "", ""};
		{ 12, 99999, "", "=q2=Aspirant´s Coif", "=ds=#a3#", "", ""};
		{ 13, 99999, "", "=q2=Aspirant´s Chaindrapes", "=ds=#a3#", "", ""};
		{ 14, 99999, "", "=q2=Aspirant´s Links", "=ds=#a3#", "", ""};
		{ 15, 99999, "", "=q2=Aspirant´s Demi-gaunts", "=ds=#a3#", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Cloche", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Pads", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Leather", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Mitts", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Pantaloons", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Riders", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Armguards", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Strap", "=ds=#a2#", "", ""};
		{ 27, 99999, "", "=q2=Aspirant´s Leglinks", "=ds=#a3#", "", ""};
		{ 28, 99999, "", "=q2=Aspirant´s Bootlinks", "=ds=#a3#", "", ""};
		{ 29, 99999, "", "=q2=Aspirant´s Wrists", "=ds=#a3#", "", ""};
		{ 30, 99999, "", "=q2=Aspirant´s Buckle", "=ds=#a3#", "", ""};
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Aspiranthep1"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Cowl", "=ds=#a1#", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Stole", "=ds=#a1#", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Raiment", "=ds=#a1#", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Hands", "=ds=#a1#", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Legwarmers", "=ds=#a1#", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Bootlets", "=ds=#a1#", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Braceletts", "=ds=#a1#", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Sash", "=ds=#a1#", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Casque", "=ds=#a2#", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Rerebrace", "=ds=#a2#", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Cuirass", "=ds=#a2#", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Palms", "=ds=#a2#", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Breeches", "=ds=#a2#", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Soles", "=ds=#a2#", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Leather Cuffs", "=ds=#a2#", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Leather Belt", "=ds=#a2#", "", ""};
		Next = "Aspiranthep2";
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Aspiranthep2"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Chain Cloche", "=ds=#a3#", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Light Pauldrons", "=ds=#a3#", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Hauberk", "=ds=#a3#", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Grips", "=ds=#a3#", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Kilt", "=ds=#a3#", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Stompers", "=ds=#a3#", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Manacles", "=ds=#a3#", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Chain", "=ds=#a3#", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Dome", "=ds=#a4#", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Platepads", "=ds=#a4#", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Breastplate", "=ds=#a4#", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Plated Fists", "=ds=#a4#", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Plate Pants", "=ds=#a4#", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Sabatons", "=ds=#a4#", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Wristguards", "=ds=#a4#", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Girdle", "=ds=#a4#", "", ""};
		Prev = "Aspiranthep1";
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Aspirantaep1"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Cap", "=ds=#a2#", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Shoulders", "=ds=#a2#", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Tunic", "=ds=#a2#", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Gloves", "=ds=#a2#", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Pants", "=ds=#a2#", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Boots", "=ds=#a2#", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Cuffs", "=ds=#a2#", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Belt", "=ds=#a2#", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Skullcap", "=ds=#a3#", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Shoulderlinks", "=ds=#a3#", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Haubergeon", "=ds=#a3#", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Chain Gloves", "=ds=#a3#", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Chausses", "=ds=#a3#", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Waders", "=ds=#a3#", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Ringed Armguards", "=ds=#a3#", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Mail Belt", "=ds=#a3#", "", ""};
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Aspirantstep1"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Helm", "=ds=#a3#", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Shoulderguards", "=ds=#a3#", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Chainmail", "=ds=#a3#", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Handguards", "=ds=#a3#", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Legguards", "=ds=#a3#", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Treads", "=ds=#a3#", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Bracers", "=ds=#a3#", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Cinch", "=ds=#a3#", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Helmet", "=ds=#a4#", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Shoulderplates", "=ds=#a4#", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Chestplate", "=ds=#a4#", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Gauntlets", "=ds=#a4#", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Legplates", "=ds=#a4#", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Greaves", "=ds=#a4#", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Armplates", "=ds=#a4#", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Waistguard", "=ds=#a4#", "", ""};
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Battlemageep1"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Battlemage's Regalia"], ""};
		{ 2, 99999, "", "=q3=Battlemage Crown", "=ds=#a1#, =q3=#c3#", "", ""};
		{ 3, 99999, "", "=q3=Battlemage Mantle", "=ds=#a1#, =q3=#c3#", "", ""};
		{ 4, 99999, "", "=q3=Battlemage Robe", "=ds=#a1#, =q3=#c3#", "", ""};
		{ 5, 99999, "", "=q3=Battlemage Gloves", "=ds=#a1#, =q3=#c3#", "", ""};
		{ 6, 99999, "", "=q3=Battlemage Leggings", "=ds=#a1#, =q3=#c3#", "", ""};
		{ 7, 99999, "", "=q3=Battlemage Boots", "=ds=#a1#, =q3=#c3#", "", ""};
		Next = "Epochsetz";
		Back = "Epochpvp55";
	};

	AtlasLoot_Data["Cenarionraep1"] = {
		{ 1, 99999, "", "=q4=Antlers of Cenarius", "", "", ""};
		{ 2, 99999, "", "=q4=Pauldrons of Cenarius", "", "", ""};
		{ 3, 99999, "", "=q4=Chestpiece of Cenarius", "", "", ""};
		{ 4, 99999, "", "=q4=Britches of Cenarius", "", "", ""};
		{ 5, 99999, "", "=q4=Gloves of Cenarius", "", "", ""};
		{ 6, 99999, "", "=q4=Striders of Cenarius", "", "", ""};
		{ 8, 99999, "", "=q4=Stag-Helm of Cenarius", "", "", ""};
		{ 9, 99999, "", "=q4=Mantle of Cenarius", "", "", ""};
		{ 10, 99999, "", "=q4=Breastplate of Cenarius", "", "", ""};
		{ 11, 99999, "", "=q4=Greaves of Cenarius", "", "", ""};
		{ 12, 99999, "", "=q4=Gauntlets of Cenarius", "", "", ""};
		{ 13, 99999, "", "=q4=Boots of Cenarius", "", "", ""};
		{ 16, 99999, "", "=q4=Crown of Cenarius", "", "", ""};
		{ 17, 99999, "", "=q4=Shoulderguards of Cenarius", "", "", ""};
		{ 18, 99999, "", "=q4=Chestguard of Cenarius", "", "", ""};
		{ 19, 99999, "", "=q4=Legguards of Cenarius", "", "", ""};
		{ 20, 99999, "", "=q4=Handguards of Cenarius", "", "", ""};
		{ 21, 99999, "", "=q4=Treads of Cenarius", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Giantstep1"] = {
		{ 1, 99999, "", "=q4=Giantstalker´s Helmet", "", "", ""};
		{ 2, 99999, "", "=q4=Giantstalker´s Epaulets", "", "", ""};
		{ 3, 99999, "", "=q4=Giantstalker´s Breastplate", "", "", ""};
		{ 4, 99999, "", "=q4=Giantstalker´s Leggings", "", "", ""};
		{ 5, 99999, "", "=q4=Giantstalker´s Gloves", "", "", ""};
		{ 6, 99999, "", "=q4=Giantstalker´s Boots", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Arcanistsep1"] = {
		{ 1, 99999, "", "=q4=Arcanist Crown", "", "", ""};
		{ 2, 99999, "", "=q4=Arcanist Mantle", "", "", ""};
		{ 3, 99999, "", "=q4=Arcanist Robes", "", "", ""};
		{ 4, 99999, "", "=q4=Arcanist Leggings", "", "", ""};
		{ 5, 99999, "", "=q4=Arcanist Gloves", "", "", ""};
		{ 6, 99999, "", "=q4=Arcanist Boots", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Lawbringep1"] = {
		{ 1, 99999, "", "=q4=Lawbringer Diadem", "", "", ""};
		{ 2, 99999, "", "=q4=Lawbringer Pauldrons", "", "", ""};
		{ 3, 99999, "", "=q4=Lawbringer Chestpiece", "", "", ""};
		{ 4, 99999, "", "=q4=Lawbringer Leggings", "", "", ""};
		{ 5, 99999, "", "=q4=Lawbringer Gloves", "", "", ""};
		{ 6, 99999, "", "=q4=Lawbringer Boots", "", "", ""};
		{ 8, 99999, "", "=q4=Lawbringer Faceguard", "", "", ""};
		{ 9, 99999, "", "=q4=Lawbringer Shoulderguards", "", "", ""};
		{ 10, 99999, "", "=q4=Lawbringer Chestguard", "", "", ""};
		{ 11, 99999, "", "=q4=Lawbringer Legguards", "", "", ""};
		{ 12, 99999, "", "=q4=Lawbringer Handguards", "", "", ""};
		{ 13, 99999, "", "=q4=Lawbringer Sabatons", "", "", ""};
		{ 16, 99999, "", "=q4=Lawbringer Crown", "", "", ""};
		{ 17, 99999, "", "=q4=Lawbringer Shoulderplates", "", "", ""};
		{ 18, 99999, "", "=q4=Lawbringer Breastplate", "", "", ""};
		{ 19, 99999, "", "=q4=Lawbringer Greaves", "", "", ""};
		{ 20, 99999, "", "=q4=Lawbringer Gauntlets", "", "", ""};
		{ 21, 99999, "", "=q4=Lawbringer Pads", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Prophep1"] = {
		{ 1, 99999, "", "=q4=Circlet of Prophecy", "", "", ""};
		{ 2, 99999, "", "=q4=Light-Mantle of Prophecy", "", "", ""};
		{ 3, 99999, "", "=q4=Robes of Prophecy", "", "", ""};
		{ 4, 99999, "", "=q4=Trousers of Prophecy", "", "", ""};
		{ 5, 99999, "", "=q4=Handwraps of Prophecy", "", "", ""};
		{ 6, 99999, "", "=q4=Boots of Prophecy", "", "", ""};
		{ 16, 99999, "", "=q4=Wreath of Prophecy", "", "", ""};
		{ 17, 99999, "", "=q4=Soul-Mantle of Prophecy", "", "", ""};
		{ 18, 99999, "", "=q4=Shroud of Prophecy", "", "", ""};
		{ 19, 99999, "", "=q4=Leggings of Prophecy", "", "", ""};
		{ 20, 99999, "", "=q4=Gloves of Prophecy", "", "", ""};
		{ 21, 99999, "", "=q4=Galoshes of Prophecy", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Nightslep1"] = {
		{ 1, 99999, "", "=q4=Nightslayer Cover", "", "", ""};
		{ 2, 99999, "", "=q4=Nightslayer Shoulder Pads", "", "", ""};
		{ 3, 99999, "", "=q4=Nightslayer Chestpiece", "", "", ""};
		{ 4, 99999, "", "=q4=Nightslayer Pants", "", "", ""};
		{ 5, 99999, "", "=q4=Nightslayer Gloves", "", "", ""};
		{ 6, 99999, "", "=q4=Nightslayer Boots", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Earthfep1"] = {
		{ 1, 99999, "", "=q4=Earthfury Faceguard", "", "", ""};
		{ 2, 99999, "", "=q4=Earthfury Shoulderguards", "", "", ""};
		{ 3, 99999, "", "=q4=Earthfury Chestguard", "", "", ""};
		{ 4, 99999, "", "=q4=Earthfury Legguards", "", "", ""};
		{ 5, 99999, "", "=q4=Earthfury Handguards", "", "", ""};
		{ 6, 99999, "", "=q4=Earthfury Boots", "", "", ""};
		{ 8, 99999, "", "=q4=Earthfury Helm", "", "", ""};
		{ 9, 99999, "", "=q4=Earthfury Shoulderplates", "", "", ""};
		{ 10, 99999, "", "=q4=Earthfury Breastplate", "", "", ""};
		{ 11, 99999, "", "=q4=Earthfury War-Kilt", "", "", ""};
		{ 12, 99999, "", "=q4=Earthfury Gauntlets", "", "", ""};
		{ 13, 99999, "", "=q4=Earthfury Sabatons", "", "", ""};
		{ 16, 99999, "", "=q4=Earthfury Headdress", "", "", ""};
		{ 17, 99999, "", "=q4=Earthfury Shoulderpads", "", "", ""};
		{ 18, 99999, "", "=q4=Earthfury Hauberk", "", "", ""};
		{ 19, 99999, "", "=q4=Earthfury Kilt", "", "", ""};
		{ 20, 99999, "", "=q4=Earthfury Gloves", "", "", ""};
		{ 21, 99999, "", "=q4=Earthfury Pads", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Felhearep1"] = {
		{ 1, 99999, "", "=q4=Felheart Horns", "", "", ""};
		{ 2, 99999, "", "=q4=Felheart Shoulder Pads", "", "", ""};
		{ 3, 99999, "", "=q4=Felheart Robes", "", "", ""};
		{ 4, 99999, "", "=q4=Felheart Pants", "", "", ""};
		{ 5, 99999, "", "=q4=Felheart Gloves", "", "", ""};
		{ 6, 99999, "", "=q4=Felheart Slippers", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Battlegeep1"] = {
		{ 1, 99999, "", "=q4=Battle-Helm of Might", "", "", ""};
		{ 2, 99999, "", "=q4=Shoulderplates of Might", "", "", ""};
		{ 3, 99999, "", "=q4=Breastplate of Might", "", "", ""};
		{ 4, 99999, "", "=q4=Greaves of Might", "", "", ""};
		{ 5, 99999, "", "=q4=Gauntlets of Might", "", "", ""};
		{ 6, 99999, "", "=q4=Sabatons of Might", "", "", ""};
		{ 16, 99999, "", "=q4=Greathelm of Might", "", "", ""};
		{ 17, 99999, "", "=q4=Shoulderguards of Might", "", "", ""};
		{ 18, 99999, "", "=q4=Chestguard of Might", "", "", ""};
		{ 19, 99999, "", "=q4=Legguards of Might", "", "", ""};
		{ 20, 99999, "", "=q4=Handguards of Might", "", "", ""};
		{ 21, 99999, "", "=q4=Sollerets of Might", "", "", ""};
		Back = "T1T2T3SET";
	};

	AtlasLoot_Data["Epochpvpwep15"] = {
		{ 1, 99999, "", "=q2=Rookie´s Dagger", "", "", ""};
		{ 2, 99999, "", "=q2=Rookie´s Hatchet", "", "", ""};
		{ 3, 99999, "", "=q2=Rookie´s Mallet", "", "", ""};
		{ 4, 99999, "", "=q2=Rookie´s Saber", "", "", ""};
		{ 5, 99999, "", "=q2=Rookie´s Claw", "", "", ""};
		{ 6, 99999, "", "=q2=Rookie´s Spellblade", "", "", ""};
		{ 7, 99999, "", "=q2=Rookie´s Frill", "", "", ""};
		{ 8, 99999, "", "=q2=Rookie´s Spellfist", "", "", ""};
		{ 9, 99999, "", "=q2=Rookie´s Spellhammer", "", "", ""};
		{ 10, 99999, "", "=q2=Rookie´s Spellsword", "", "", ""};
		{ 11, 99999, "", "=q2=Rookie´s Staff", "", "", ""};
		{ 12, 99999, "", "=q2=Rookie´s Battleaxe", "", "", ""};
		{ 13, 99999, "", "=q2=Rookie´s Maul", "", "", ""};
		{ 14, 99999, "", "=q2=Rookie´s Greatsword", "", "", ""};
		{ 15, 99999, "", "=q2=Rookie´s Spellshield", "", "", ""};
		{ 16, 99999, "", "=q2=Rookie´s Shield", "", "", ""};
		{ 17, 99999, "", "=q2=Rookie´s Axe", "", "", ""};
		{ 18, 99999, "", "=q2=Rookie´s Mace", "", "", ""};
		{ 19, 99999, "", "=q2=Rookie´s Sword", "", "", ""};
		{ 20, 99999, "", "=q2=Rookie´s Knuckles", "", "", ""};
		{ 22, 99999, "", "=q2=Rookie´s Rifle", "", "", ""};
		{ 23, 99999, "", "=q2=Rookie´s Bow", "", "", ""};
		{ 24, 99999, "", "=q2=Rookie´s Crossbow", "", "", ""};
		{ 25, 99999, "", "=q2=Rookie´s Knives", "", "", ""};
		{ 26, 99999, "", "=q2=Rookie´s Frostflinger", "", "", ""};
		{ 27, 99999, "", "=q2=Rookie´s Firestick", "", "", ""};
		{ 28, 99999, "", "=q2=Rookie´s Shadowthrower", "", "", ""};
		{ 29, 99999, "", "=q2=Rookie´s Arcane Wand", "", "", ""};
		{ 30, 99999, "", "=q2=Rookie´s Lightning Rod", "", "", ""};
		Back = "Epochpvp15";
	};

	AtlasLoot_Data["Epochpvpmisc15"] = {
		{ 14, 99999, "", "=q2=Emblem of Tenacity", "", "", ""};
		{ 15, 99999, "", "=q2=Insignia of the Alliance", "", "", ""};
		{ 1, 99999, "", "=q2=Band of Physical Potency", "", "", ""};
		{ 2, 99999, "", "=q2=Band of Physical Cruelty", "", "", ""};
		{ 3, 99999, "", "=q2=Band of Physical Accuracy", "", "", ""};
		{ 4, 99999, "", "=q2=Band of Magic Potency", "", "", ""};
		{ 5, 99999, "", "=q2=Band of Magic Cruelty", "", "", ""};
		{ 6, 99999, "", "=q2=Band of Magic Accuracy", "", "", ""};
		{ 7, 99999, "", "=q2=Band of Survival", "", "", ""};
		{ 9, 99999, "", "=q2=Amulet of Agility", "", "", ""};
		{ 10, 99999, "", "=q2=Amulet of Strength", "", "", ""};
		{ 11, 99999, "", "=q2=Amulet of Spellcasting", "", "", ""};
		{ 16, 99999, "", "=q2=Cloak of Pyhsical Potency", "", "", ""};
		{ 17, 99999, "", "=q2=Cloak of Physical Cruelty", "", "", ""};
		{ 18, 99999, "", "=q2=Cloak of Physical Accuracy", "", "", ""};
		{ 19, 99999, "", "=q2=Cloak of Magic Potency", "", "", ""};
		{ 20, 99999, "", "=q2=Cloak of Magic Cruelty", "", "", ""};
		{ 21, 99999, "", "=q2=Cloak of Magic Accuracy", "", "", ""};
		{ 22, 99999, "", "=q2=Cloak of Survival", "", "", ""};
		{ 30, 99999, "", "=q2=Insignia of the Horde", "", "", ""};
		Back = "Epochpvp15";
	};

	AtlasLoot_Data["Epochpvpwep25"] = {
		{ 1, 99999, "", "=q2=Skirmisher´s Dagger", "", "", ""};
		{ 2, 99999, "", "=q2=Skirmisher´s Hatchet", "", "", ""};
		{ 3, 99999, "", "=q2=Skirmisher´s Mallet", "", "", ""};
		{ 4, 99999, "", "=q2=Skirmisher´s Saber", "", "", ""};
		{ 5, 99999, "", "=q2=Skirmisher´s Claw", "", "", ""};
		{ 6, 99999, "", "=q2=Skirmisher´s Spellblade", "", "", ""};
		{ 7, 99999, "", "=q2=Skirmisher´s Frill", "", "", ""};
		{ 8, 99999, "", "=q2=Skirmisher´s Spellfist", "", "", ""};
		{ 9, 99999, "", "=q2=Skirmisher´s Spellhammer", "", "", ""};
		{ 10, 99999, "", "=q2=Skirmisher´s Spellsword", "", "", ""};
		{ 11, 99999, "", "=q2=Skirmisher´s Staff", "", "", ""};
		{ 12, 99999, "", "=q2=Skirmisher´s Battleaxe", "", "", ""};
		{ 13, 99999, "", "=q2=Skirmisher´s Maul", "", "", ""};
		{ 14, 99999, "", "=q2=Skirmisher´s Greatsword", "", "", ""};
		{ 15, 99999, "", "=q2=Skirmisher´s Spellshield", "", "", ""};
		{ 16, 99999, "", "=q2=Skirmisher´s Shield", "", "", ""};
		{ 17, 99999, "", "=q2=Skirmisher´s Axe", "", "", ""};
		{ 18, 99999, "", "=q2=Skirmisher´s Mace", "", "", ""};
		{ 19, 99999, "", "=q2=Skirmisher´s Sword", "", "", ""};
		{ 20, 99999, "", "=q2=Skirmisher´s Knuckles", "", "", ""};
		{ 22, 99999, "", "=q2=Skirmisher´s Rifle", "", "", ""};
		{ 23, 99999, "", "=q2=Skirmisher´s Bow", "", "", ""};
		{ 24, 99999, "", "=q2=Skirmisher´s Crossbow", "", "", ""};
		{ 25, 99999, "", "=q2=Skirmisher´s Knives", "", "", ""};
		{ 26, 99999, "", "=q2=Skirmisher´s Frostflinger", "", "", ""};
		{ 27, 99999, "", "=q2=Skirmisher´s Firestick", "", "", ""};
		{ 28, 99999, "", "=q2=Skirmisher´s Shadowthrower", "", "", ""};
		{ 29, 99999, "", "=q2=Skirmisher´s Arcane Wand", "", "", ""};
		{ 30, 99999, "", "=q2=Skirmisher´s Lightning Rod", "", "", ""};
		Back = "Epochpvp25";
	};
	...
	AtlasLoot_Data["Epochpvpwep35"] = {
		{ 1, 99999, "", "=q2=Combatant´s Dagger", "", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Hatchet", "", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Mallet", "", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Saber", "", "", ""};
		{ 5, 99999, "", "=q2=Combatant´s Claw", "", "", ""};
		{ 6, 99999, "", "=q2=Combatant´s Spellblade", "", "", ""};
		{ 7, 99999, "", "=q2=Combatant´s Medical Knife", "", "", ""};
		{ 8, 99999, "", "=q2=Combatant´s Frill", "", "", ""};
		{ 9, 99999, "", "=q2=Combatant´s Tome", "", "", ""};
		{ 10, 99999, "", "=q2=Combatant´s Staff", "", "", ""};
		{ 11, 99999, "", "=q2=Combatant´s Stave", "", "", ""};
		{ 12, 99999, "", "=q2=Combatant´s Spellfist", "", "", ""};
		{ 13, 99999, "", "=q2=Combatant´s Spellhammer", "", "", ""};
		{ 14, 99999, "", "=q2=Combatant´s Spellsword", "", "", ""};
		{ 15, 99999, "", "=q2=Combatant´s Healing Knuckles", "", "", ""};
		{ 16, 99999, "", "=q2=Combatant´s Scepter", "", "", ""};
		{ 17, 99999, "", "=q2=Combatant´s Brand", "", "", ""};
		{ 18, 99999, "", "=q2=Combatant´s Battleaxe", "", "", ""};
		{ 19, 99999, "", "=q2=Combatant´s Maul", "", "", ""};
		{ 20, 99999, "", "=q2=Combatant´s Greatsword", "", "", ""};
		{ 21, 99999, "", "=q2=Combatant´s Spellshield", "", "", ""};
		{ 22, 99999, "", "=q2=Combatant´s Shield", "", "", ""};
		{ 23, 99999, "", "=q2=Combatant´s Protector", "", "", ""};
		{ 24, 99999, "", "=q2=Combatant´s Axe", "", "", ""};
		{ 25, 99999, "", "=q2=Combatant´s Mace", "", "", ""};
		{ 26, 99999, "", "=q2=Combatant´s Sword", "", "", ""};
		{ 27, 99999, "", "=q2=Combatant´s Knuckles", "", "", ""};
		Next = "Epochpvpwep235";
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Epochpvpwep235"] = {
		{ 1, 99999, "", "=q2=Combatant´s Rifle", "", "", ""};
		{ 2, 99999, "", "=q2=Combatant´s Bow", "", "", ""};
		{ 3, 99999, "", "=q2=Combatant´s Crossbow", "", "", ""};
		{ 4, 99999, "", "=q2=Combatant´s Knives", "", "", ""};
		{ 16, 99999, "", "=q2=Combatant´s Frostflinger", "", "", ""};
		{ 17, 99999, "", "=q2=Combatant´s Firestick", "", "", ""};
		{ 18, 99999, "", "=q2=Combatant´s Shadowthrower", "", "", ""};
		{ 19, 99999, "", "=q2=Combatant´s Arcane Wand", "", "", ""};
		{ 20, 99999, "", "=q2=Combatant´s Lightning Rod", "", "", ""};
		Prev = "Epochpvpwep35";
		Back = "Epochpvp35";
	};
	...
	AtlasLoot_Data["Epochpvpmisc35"] = {
		...
		{ 17, 99999, "", "=q2=Cloak of Physical Cruelty", "", "", ""};
		{ 18, 99999, "", "=q2=Cloak of Physical Accuracy", "", "", ""};
		{ 19, 99999, "", "=q2=Cloak of Meditation", "", "", ""};
		{ 20, 99999, "", "=q2=Cloak of Magic Potency", "", "", ""};
		{ 21, 99999, "", "=q2=Cloak of Magic Cruelty", "", "", ""};
		{ 22, 99999, "", "=q2=Cloak of Magic Accuracy", "", "", ""};
		{ 23, 99999, "", "=q2=Cloak of Survival", "", "", ""};
		{ 30, 99999, "", "=q2=Insignia of the Horde", "", "", ""};
		Back = "Epochpvp35";
	};

	AtlasLoot_Data["Epochpvpwep45"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Dagger", "", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Hatchet", "", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Mallet", "", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Saber", "", "", ""};
		{ 5, 99999, "", "=q2=Aspirant´s Claw", "", "", ""};
		{ 6, 99999, "", "=q2=Aspirant´s Spellblade", "", "", ""};
		{ 7, 99999, "", "=q2=Aspirant´s Medical Knife", "", "", ""};
		{ 8, 99999, "", "=q2=Aspirant´s Frill", "", "", ""};
		{ 9, 99999, "", "=q2=Aspirant´s Tome", "", "", ""};
		{ 10, 99999, "", "=q2=Aspirant´s Staff", "", "", ""};
		{ 11, 99999, "", "=q2=Aspirant´s Stave", "", "", ""};
		{ 12, 99999, "", "=q2=Aspirant´s Spellfist", "", "", ""};
		{ 13, 99999, "", "=q2=Aspirant´s Spellhammer", "", "", ""};
		{ 14, 99999, "", "=q2=Aspirant´s Spellsword", "", "", ""};
		{ 15, 99999, "", "=q2=Aspirant´s Healing Knuckles", "", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Scepter", "", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Brand", "", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Battleaxe", "", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Maul", "", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Greatsword", "", "", ""};
		{ 21, 99999, "", "=q2=Aspirant´s Spellshield", "", "", ""};
		{ 22, 99999, "", "=q2=Aspirant´s Shield", "", "", ""};
		{ 23, 99999, "", "=q2=Aspirant´s Protector", "", "", ""};
		{ 24, 99999, "", "=q2=Aspirant´s Axe", "", "", ""};
		{ 25, 99999, "", "=q2=Aspirant´s Mace", "", "", ""};
		{ 26, 99999, "", "=q2=Aspirant´s Sword", "", "", ""};
		{ 27, 99999, "", "=q2=Aspirant´s Knuckles", "", "", ""};
		Next = "Epochpvpwep245";
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Epochpvpwep245"] = {
		{ 1, 99999, "", "=q2=Aspirant´s Rifle", "", "", ""};
		{ 2, 99999, "", "=q2=Aspirant´s Bow", "", "", ""};
		{ 3, 99999, "", "=q2=Aspirant´s Crossbow", "", "", ""};
		{ 4, 99999, "", "=q2=Aspirant´s Knives", "", "", ""};
		{ 16, 99999, "", "=q2=Aspirant´s Frostflinger", "", "", ""};
		{ 17, 99999, "", "=q2=Aspirant´s Firestick", "", "", ""};
		{ 18, 99999, "", "=q2=Aspirant´s Shadowthrower", "", "", ""};
		{ 19, 99999, "", "=q2=Aspirant´s Arcane Wand", "", "", ""};
		{ 20, 99999, "", "=q2=Aspirant´s Lightning Rod", "", "", ""};
		Prev = "Epochpvpwep45";
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Epochpvpmisc45"] = {
		{ 1, 99999, "", "=q2=Emblem of Renewal", "", "", ""};
		{ 2, 99999, "", "=q2=Emblem of Upturn", "", "", ""};
		{ 3, 99999, "", "=q2=Emblem of Power", "", "", ""};
		{ 4, 99999, "", "=q2=Emblem of Alacrity", "", "", ""};
		{ 5, 99999, "", "=q2=Emblem of Dominance", "", "", ""};
		{ 6, 99999, "", "=q2=Emblem of Betterment", "", "", ""};
		{ 7, 99999, "", "=q2=Emblem of Cogitation", "", "", ""};
		{ 8, 99999, "", "=q2=Emblem of Magick", "", "", ""};
		{ 9, 99999, "", "=q2=Emblem of Ferocity", "", "", ""};
		{ 10, 99999, "", "=q2=Emblem of Vigor", "", "", ""};
		{ 11, 99999, "", "=q2=Emblem of Tenacity", "", "", ""};
		{ 13, 99999, "", "=q2=Insignia of Relentlessness", "", "", ""};
		{ 14, 99999, "", "=q2=Insignia of Adaptation", "", "", ""};
		{ 15, 99999, "", "=q2=Insignia of the Alliance", "", "", ""};
		{ 16, 99999, "", "=q2=Band of Physical Potency", "", "", ""};
		{ 17, 99999, "", "=q2=Band of Physical Cruelty", "", "", ""};
		{ 18, 99999, "", "=q2=Band of Physical Accuracy", "", "", ""};
		{ 19, 99999, "", "=q2=Band of Meditation", "", "", ""};
		{ 20, 99999, "", "=q2=Band of Magic Potency", "", "", ""};
		{ 21, 99999, "", "=q2=Band of Magic Cruelty", "", "", ""};
		{ 22, 99999, "", "=q2=Band of Magic Accuracy", "", "", ""};
		{ 23, 99999, "", "=q2=Band of Survival", "", "", ""};
		{ 30, 99999, "", "=q2=Insignia of the Horde", "", "", ""};
	...
	AtlasLoot_Data["Epochpvpmisc245"] = {
		{ 1, 99999, "", "=q2=Cloak of Pyhsical Potency", "", "", ""};
		{ 2, 99999, "", "=q2=Cloak of Physical Cruelty", "", "", ""};
		{ 3, 99999, "", "=q2=Cloak of Physical Accuracy", "", "", ""};
		{ 4, 99999, "", "=q2=Cloak of Meditation", "", "", ""};
		{ 5, 99999, "", "=q2=Cloak of Magic Potency", "", "", ""};
		{ 6, 99999, "", "=q2=Cloak of Magic Cruelty", "", "", ""};
		{ 7, 99999, "", "=q2=Cloak of Magic Accuracy", "", "", ""};
		{ 8, 99999, "", "=q2=Cloak of Survival", "", "", ""};
		{ 16, 99999, "", "=q2=Amulet of Meditation", "", "", ""};
		{ 17, 99999, "", "=q2=Amulet of Agility", "", "", ""};
		{ 18, 99999, "", "=q2=Amulet of Strength", "", "", ""};
		{ 19, 99999, "", "=q2=Amulet of Spellcasting", "", "", ""};
		Prev = "Epochpvpmisc45";
		Back = "Epochpvp45";
	};

	AtlasLoot_Data["Epochpvpwep55"] = {
		{ 11, 99999, "", "=q3=Soldier´s Frostflinger", "=ds=", "1 #wsg#", ""};
		{ 12, 99999, "", "=q3=Soldier´s  Firestick", "=ds=", "1 #wsg#", ""};
		{ 13, 99999, "", "=q3=Soldier´s  Shadowthrower", "=ds=", "1 #wsg#", ""};
		{ 14, 99999, "", "=q3=Soldier´s  Arcane Wand", "=ds=", "1 #wsg#", ""};
		{ 15, 99999, "", "=q3=Soldier´s  Lightning Rod", "=ds=", "1 #wsg#", ""};
		Back = "Epochpvp55";
	};

	AtlasLoot_Data["Epochpvpmisc55"] = {
		{ 1, 99999, "", "=q3=Emblem of Renewal", "=ds=", "1 #wsg#", ""};
		{ 2, 99999, "", "=q3=Emblem of Upturn", "=ds=", "1 #wsg#", ""};
		{ 3, 99999, "", "=q3=Emblem of Power", "=ds=", "1 #wsg#", ""};
		{ 4, 99999, "", "=q3=Emblem of Alacrity", "=ds=", "1 #wsg#", ""};
		{ 5, 99999, "", "=q3=Emblem of Dominance", "=ds=", "1 #wsg#", ""};
		{ 6, 99999, "", "=q3=Emblem of Betterment", "=ds=", "1 #wsg#", ""};
		{ 7, 99999, "", "=q3=Emblem of Cogitation", "=ds=", "1 #wsg#", ""};
		{ 8, 99999, "", "=q3=Emblem of Magick", "=ds=", "1 #wsg#", ""};
		{ 9, 99999, "", "=q3=Emblem of Ferocity", "=ds=", "1 #wsg#", ""};
		{ 10, 99999, "", "=q3=Emblem of Vigor", "=ds=", "1 #wsg#", ""};
		{ 11, 99999, "", "=q3=Emblem of Tenacity", "=ds=", "1 #wsg#", ""};
		{ 13, 99999, "", "=q3=Insignia of Relentlessness", "=ds=", "1 #wsg#", ""};
		{ 14, 99999, "", "=q3=Insignia of Adaptation", "=ds=", "1 #wsg#", ""};
		{ 15, 99999, "", "=q3=Insignia of the Alliance", "=ds=", "1 #wsg#", ""};
		{ 16, 99999, "", "=q3=Band of Physical Potency", "=ds=", "1 #wsg#", ""};
		{ 17, 99999, "", "=q3=Band of Physical Crit", "=ds=", "1 #wsg#", ""};
		{ 18, 99999, "", "=q3=Band of Physical Accuracy", "=ds=", "1 #wsg#", ""};
		{ 19, 99999, "", "=q3=Band of Magic Potency", "=ds=", "1 #wsg#", ""};
		{ 20, 99999, "", "=q3=Band of Magic Cruelty", "=ds=", "1 #wsg#", ""};
		{ 21, 99999, "", "=q3=Band of Magic Accuracy", "=ds=", "1 #wsg#", ""};
		{ 22, 99999, "", "=q3=Band of Survival", "=ds=", "1 #wsg#", ""};
		{ 23, 99999, "", "=q3=Band of Meditation", "=ds=", "1 #wsg#", ""};
		{ 25, 99999, "", "=q4=Powerfull Amulet of Spellcasting", "=ds=", "1 #wsg#", ""};
		{ 26, 99999, "", "=q3=Amulet of Spellcasting", "=ds=", "1 #wsg#", ""};
		{ 30, 99999, "", "=q3=Insignia of the Horde", "=ds=", "1 #wsg#", ""};
		Next = "Epochpvpmisc255";
		Back = "Epochpvp55";
	};

	AtlasLoot_Data["Epochpvpmisc255"] = {
		{ 1, 99999, "", "=q3=Cloak of Pyhsical Potency", "=ds=", "1 #wsg#", ""};
		{ 2, 99999, "", "=q3=Cloak of Physical Cruelty", "=ds=", "1 #wsg#", ""};
		{ 3, 99999, "", "=q3=Cloak of Physical Accuracy", "=ds=", "1 #wsg#", ""};
		{ 4, 99999, "", "=q3=Cloak of Magic Potency", "=ds=", "1 #wsg#", ""};
		{ 5, 99999, "", "=q3=Cloak of Magic Cruelty", "=ds=", "1 #wsg#", ""};
		{ 6, 99999, "", "=q3=Cloak of Magic Accuracy", "=ds=", "1 #wsg#", ""};
		{ 7, 99999, "", "=q3=Cloak of Survival", "=ds=", "1 #wsg#", ""};
		{ 8, 99999, "", "=q3=Cloak of Meditation", "=ds=", "1 #wsg#", ""};
		Prev = "Epochpvpmisc55";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochpvpworld"] = {
		{ 1, 99999, "", "=q6=Bloody Token", "", "", ""};
		{ 3, 99999, "", "=q3=Title Scroll: The Bloodthirsty", "=ds=", "1 #epvpw#", ""};
		{ 4, 99999, "", "=q3=Glyph of Bloody Retreat", "=ds=", "1 #epvpw#", ""};
		{ 5, 49052, "", "=q3=Tabard of Savagery", "=ds=", "1 #epvpw#", ""};
		{ 6, 38578, "", "=q3=The Flag of Ownership", "=ds=", "1 #epvpw#", ""};
		{ 18, 99999, "", "=q1=Spiked Net", "=ds=", "1 #epvpw#", ""};
		{ 19, 99999, "", "=q1=Potion of Closing", "=ds=", "1 #epvpw#", ""};
		{ 20, 99999, "", "=q1=Rocket Powered Punch", "=ds=", "1 #epvpw#", ""};
		{ 8, 99999, "", "=q2=Alliance Balloon", "=ds=", "1 #epvpw#", ""};
		{ 23, 99999, "", "=q2=Horde Balloon", "=ds=", "1 #epvpw#", ""};
		Back = "EPOCHPVPSETMENU";
	};

	AtlasLoot_Data["Epochpvps1"] = {
		{ 1, 99999, "", "=q3=Battlemaster´s Emblem", "", "", ""};
		{ 2, 99999, "", "=q3=Insignia of the Horde", "", "", ""};
		Back = "EPOCHPVPSETMENU";
	};
	...
	AtlasLoot_Data["Epochset"] = {
		...
		{ 2, 99999, "", "=q3=Rune Warder´s Crown", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Rune Warder´s Mantle", "=ds="..BabbleEpoch["Dak´mal"].." ("..BabbleEpoch["Baradin Hold"]..")", "", ""};
		{ 4, 99999, "", "=q3=Rune Warder´s Raiment", "=ds=", "=ds="..BabbleEpoch["Calypso"].." ("..BabbleEpoch["Baradin Hold"]..")", "", ""};
		{ 5, 99999, "", "=q3=Rune Warder´s Gloves", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Rune Warder´s Loins", "=ds="..BabbleEpoch["Astilos the Hollow"].." ("..BabbleEpoch["Baradin Hold"]..")", "", ""};
		{ 7, 99999, "", "=q3=Rune Warder´s Boots", "=ds=", "", ""};
		Prev = "BaradinHold2";
	};
	...
	AtlasLoot_Data["Epochset4"] = {
		...
		{ 2, 99999, "", "=q4=Treeheart Cowl", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Treeheart Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q4=Treeheart Vest", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Treeheart Bracers", "=ds=", "", ""};
		{ 6, 99999, "", "=q4=Treeheart Gloves", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Treeheart Belt", "=ds=", "", ""};
		{ 8, 99999, "", "=q3=Treeheart Kilt", "=ds=", "", ""};
		{ 9, 99999, "", "=q4=Treeheart Boots", "=ds=", "", ""};
		...
		{ 12, 99999, "", "=q4=Featherheart Cowl", "=ds=", "", ""};
		{ 13, 99999, "", "=q3=Featherheart Spaulders", "=ds=", "", ""};
		{ 14, 99999, "", "=q4=Featherheart Vest", "=ds=", "", ""};
		{ 15, 99999, "", "=q3=Featherheart Bracers", "=ds=", "", ""};
		{ 27, 99999, "", "=q4=Featherheart Gloves", "=ds=", "", ""};
		{ 28, 99999, "", "=q3=Featherheart Belt", "=ds=", "", ""};
		{ 29, 99999, "", "=q3=Featherheart Kilt", "=ds=", "", ""};
		{ 30, 99999, "", "=q4=Featherheart Boots", "=ds=", "", ""};
		Prev = "T0Druid";
		Back = "T0SET";
	};
	...
	AtlasLoot_Data["Epochset9"] = {
		...
		{ 2, 99999, "", "=q4=Holyforge Helm", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Holyforge Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q4=Holyforge Breastplate", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Holyforge Bracers", "=ds=", "", ""};
		{ 6, 99999, "", "=q4=Holyforge Gauntlets", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Holyforge Belt", "=ds=", "", ""};
		{ 8, 99999, "", "=q3=Holyforge Legplates", "=ds=", "", ""};
		{ 9, 99999, "", "=q4=Holyforge Boots", "=ds=", "", ""};
		...
		{ 12, 99999, "", "=q4=Vigilforge Helm", "=ds=", "", ""};
		{ 13, 99999, "", "=q3=Vigilforge Spaulders", "=ds=", "", ""};
		{ 14, 99999, "", "=q4=Vigilforge Breastplate", "=ds=", "", ""};
		{ 15, 99999, "", "=q3=Vigilforge Bracers", "=ds=", "", ""};
		{ 27, 99999, "", "=q4=Vigilforge Gauntlets", "=ds=", "", ""};
		{ 28, 99999, "", "=q3=Vigilforge Belt", "=ds=", "", ""};
		{ 29, 99999, "", "=q3=Vigilforge Legplates", "=ds=", "", ""};
		{ 30, 99999, "", "=q4=Vigilforge Boots", "=ds=", "", ""};
		Prev = "T0Paladin";
		Back = "T0SET";
	};
	...
	AtlasLoot_Data["Epochset11"] = {
		...
		{ 2, 99999, "", "=q4=Pious Crown", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Pious Mantle", "=ds=", "", ""};
		{ 4, 99999, "", "=q4=Pious Robe", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Pious Bracers", "=ds=", "", ""};
		{ 6, 99999, "", "=q4=Pious Gloves", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Pious Belt", "=ds=", "", ""};
		{ 8, 99999, "", "=q3=Pious Skirt", "=ds=", "", ""};
		{ 9, 99999, "", "=q4=Pious Sandals", "=ds=", "", ""};
	...
	AtlasLoot_Data["Epochset14"] = {
		...
		{ 17, 99999, "", "=q4=Coif of Aftershock", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Pauldrons of Aftershock", "=ds=", "", ""};
		{ 19, 99999, "", "=q4=Vest of Aftershock", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Cord of Aftershock", "=ds=", "", ""};
		{ 22, 99999, "", "=q4=Gauntlets of Aftershock", "=ds=", "", ""};
		{ 23, 99999, "", "=q3=Kilt of Aftershock", "=ds=", "", ""};
		{ 24, 99999, "", "=q4=Boots of Aftershock", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Bindings of Aftershock", "=ds=", "", ""};
		{ 11, 0, "Spell_FireResistanceTotem_01", "=q6="..BabbleEpoch["The Great Sea"], "=ec1=#j7#"};
		{ 12, 99999, "", "=q4=Coif of the Great Sea", "=ds=", "", ""};
		{ 13, 99999, "", "=q3=Pauldrons of the Great Sea", "=ds=", "", ""};
		{ 14, 99999, "", "=q4=Vest of the Great Sea", "=ds=", "", ""};
		{ 15, 99999, "", "=q3=Bindings of the Great Sea", "=ds=", "", ""};
		{ 27, 99999, "", "=q4=Gauntlets of the Great Sea", "=ds=", "", ""};
		{ 28, 99999, "", "=q3=Cord of the Great Sea", "=ds=", "", ""};
		{ 29, 99999, "", "=q3=Kilt of the Great Sea", "=ds=", "", ""};
		{ 30, 99999, "", "=q4=Boots of the Great Sea", "=ds=", "", ""};
		Prev = "T0Shaman";
		Back = "T0SET";
	};
	...
	AtlasLoot_Data["Epochsetz"] = {
		...
		{ 2, 99999, "", "=q3=Divined Crown", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Divined Mantle", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Divined Robe", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Divined Gloves", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Divined Skirt", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Divined Sandals", "=ds=", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Vanta Vestments"], ""};
		{ 17, 99999, "", "=q3=Vanta Mask", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Vanta Mantle", "=ds=", "", ""};
		{ 19, 99999, "", "=q3=Vanta Robe", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Vanta Wraps", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Vanta Leggings", "=ds=", "", ""};
		{ 22, 99999, "", "=q3=Vanta Sandals", "=ds=", "", ""};
		Prev = "Battlemageep1";
		Next = "Epochsetz1";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz1"] = {
		...
		{ 2, 99999, "", "=q3=Shadowcaster Mask", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Shadowcaster Mantle", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Shadowcaster Robe", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Shadowcaster Wraps", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Shadowcaster Leggings", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Shadowcaster Sandals", "=ds=", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Afflictor"], ""};
		{ 17, 99999, "", "=q3=Afflictor Mask", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Afflictor Mantle", "=ds=", "", ""};
		{ 19, 99999, "", "=q3=Afflictor Robe", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Afflictor Wraps", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Afflictor Leggings", "=ds=", "", ""};
		{ 22, 99999, "", "=q3=Afflictor Sandals", "=ds=", "", ""};
		Next = "Epochsetz2";
		Prev = "Epochsetz";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz2"] = {
		...
		{ 2, 99999, "", "=q3=Astral Cowl", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Astral Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Astral Vest", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Astral Gloves", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Astral Kilt", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Astral Boots", "=ds=", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Barking Armor"], ""};
		{ 17, 99999, "", "=q3=Barking Cowl", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Barking Spaulders", "=ds=", "", ""};
		{ 19, 99999, "", "=q3=Barking Vest", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Barking Gloves", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Barking Kilt", "=ds=", "", ""};
		{ 22, 99999, "", "=q3=Barking Boots", "=ds=", "", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Animalistic Armor"], ""};
		{ 10, 99999, "", "=q3=Animalistic Cowl", "=ds=", "", ""};
		{ 11, 99999, "", "=q3=Animalistic Spaulders", "=ds=", "", ""};
		{ 12, 99999, "", "=q3=Animalistic Vest", "=ds=", "", ""};
		{ 13, 99999, "", "=q3=Animalistic Gloves", "=ds=", "", ""};
		{ 14, 99999, "", "=q3=Animalistic Kilt", "=ds=", "", ""};
		{ 15, 99999, "", "=q3=Animalistic Boots", "=ds=", "", ""};
		Next = "Epochsetz3";
		Prev = "Epochsetz1";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz3"] = {
		...
		{ 2, 99999, "", "=q3=Scouting Cap", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Scouting Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Scouting Tunic", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Scouting Gloves", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Scouting Pants", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Scouting Boots", "=ds=", "", ""};
		Next = "Epochsetz4";
		Prev = "Epochsetz2";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz4"] = {
		...
		{ 2, 99999, "", "=q3=Ranger Cap", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Ranger Mantle", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Ranger Tunic", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Ranger Gloves", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Ranger Pants", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Ranger Boots", "=ds=", "", ""};
		Next = "Epochsetz5";
		Prev = "Epochsetz3";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz5"] = {
		...
		{ 2, 99999, "", "=q3=Capacitor Coif", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Capacitor Pauldrons", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Capacitor Vest", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Capacitor Gauntlets", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Capacitor Kilt", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Capacitor Boots", "=ds=", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Tidal Armor"], ""};
		{ 17, 99999, "", "=q3=Tidal Coif", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Tidal Pauldrons", "=ds=", "", ""};
		{ 19, 99999, "", "=q3=Tidal Vest", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Tidal Gauntlets", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Tidal Kilt", "=ds=", "", ""};
		{ 22, 99999, "", "=q3=Tidal Boots", "=ds=", "", ""};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleEpoch["Shockchain Armor"], ""};
		{ 10, 99999, "", "=q3=Shockchain Coif", "=ds=", "", ""};
		{ 11, 99999, "", "=q3=Shockchain Pauldrons", "=ds=", "", ""};
		{ 12, 99999, "", "=q3=Shockchain Vest", "=ds=", "", ""};
		{ 13, 99999, "", "=q3=Shockchain Gauntlets", "=ds=", "", ""};
		{ 14, 99999, "", "=q3=Shockchain Kilt", "=ds=", "", ""};
		{ 15, 99999, "", "=q3=Shockchain Boots", "=ds=", "", ""};
		Next = "Epochsetz6";
		Prev = "Epochsetz4";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz6"] = {
		...
		{ 2, 99999, "", "=q3=Righteous Helm", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Righteous Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Righteous Breastplate", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Righteous Gauntlets", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Righteous Legplates", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Righteous Boots", "=ds=", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Truthful Armor"], ""};
		{ 17, 99999, "", "=q3=Truthful Helm", "=ds=", "", ""};
		{ 18, 99999, "", "=q3=Truthful Spaulders", "=ds=", "", ""};
		{ 19, 99999, "", "=q3=Truthful Breastplate", "=ds=", "", ""};
		{ 20, 99999, "", "=q3=Truthful Gauntlets", "=ds=", "", ""};
		{ 21, 99999, "", "=q3=Truthful Legplates", "=ds=", "", ""};
		{ 22, 99999, "", "=q3=Truthful Boots", "=ds=", "", ""};
		Next = "Epochsetz7";
		Prev = "Epochsetz5";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["Epochsetz7"] = {
		...
		{ 2, 99999, "", "=q3=Plated Helm", "=ds=", "", ""};
		{ 3, 99999, "", "=q3=Plated Spaulders", "=ds=", "", ""};
		{ 4, 99999, "", "=q3=Plated Breast", "=ds=", "", ""};
		{ 5, 99999, "", "=q3=Plated Gauntlets", "=ds=", "", ""};
		{ 6, 99999, "", "=q3=Plated Legs", "=ds=", "", ""};
		{ 7, 99999, "", "=q3=Plated Boots", "=ds=", "", ""};
		Prev = "Epochsetz6";
		Back = "Epochpvp55";
	};
	...
	AtlasLoot_Data["WSGMisc"] = {
		...
		{ 9, 99999, "", "=q1=Silverwing Supply Box", "=ds=", "3 #wsg#", ""};
		{ 10, 99999, "", "=q3=Silverwing Insignia", "=ds=", "9 #wsg#", ""};
	...
	AtlasLoot_Data["Auberdine"] = {
		...
		{ 2, 99999, "", "=q2=Auberdine Gloves", ""};
		{ 3, 99999, "", "=q2=Auberdine Gauntlets", ""};
		{ 4, 99999, "", "=q2=Auberdine Handwraps", ""};
		{ 6, 0, "Achievement_character_nightelf_female", "=q6=#r3#", ""};
		{ 7, 99999, "", "=q2=Auberdine Mantle", ""};
		{ 8, 99999, "", "=q2=Auberdine Shoulderpads", ""};
		{ 9, 99999, "", "=q2=Auberdine Spaulders", ""};
		{ 16, 0, "Achievement_character_nightelf_female", "=q6=#r4#", ""};
		{ 17, 99999, "", "=q2=Auberdine Hat", ""};
		{ 18, 99999, "", "=q2=Auberdine Headwrap", ""};
		{ 19, 99999, "", "=q2=Auberdine Helmet", ""};
		{ 21, 0, "Achievement_character_nightelf_female", "=q6=#r5#", ""};
		{ 22, 99999, "", "=q3=Auberdine Amulet", ""};
		{ 23, 99999, "", "=q3=Moonkin Rod", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["WildhammerClan"] = {
		...
		{ 2, 99999, "", "=q2=Aerie Mittens", ""};
		{ 3, 99999, "", "=q2=Wildhammer Wraps", ""};
		{ 4, 99999, "", "=q2=Ancient Chain Gage", ""};
		{ 5, 99999, "", "=q2=Snapjaw Shell Gauntlets", ""};
		{ 7, 0, "ability_mount_goldengryphon", "=q6=#r3#", ""};
		{ 8, 99999, "", "=q2=Sentry Off Cuts", ""};
		{ 9, 99999, "", "=q2=Gryphon Tamer Boots", ""};
		{ 10, 99999, "", "=q2=Aerie Boots", ""};
		{ 11, 99999, "", "=q2=Mountainous Sabatons", ""};
		{ 16, 0, "ability_mount_goldengryphon", "=q6=#r4#", ""};
		{ 17, 99999, "", "=q2=Hinterland Girdle", ""};
		{ 18, 99999, "", "=q2=Winged Belt", ""};
		{ 19, 99999, "", "=q2=Rustic Wildhammer Girdle", ""};
		{ 20, 99999, "", "=q2=Aerie Band", ""};
		{ 22, 0, "ability_mount_goldengryphon", "=q6=#r5#", ""};
		{ 23, 99999, "", "=q3=Falstad´s Cloak", ""};
		{ 24, 99999, "", "=q3=Gryphon Rider Drape", ""};
		{ 25, 99999, "", "=q3=Aviary Shroud", ""};
		{ 26, 99999, "inv_misc_pet_02", "=q3=Gryphon Hatchling", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["RaventuskTribe"] = {
		...
		{ 2, 99999, "", "=q2=Forest Mitten", ""};
		{ 3, 99999, "", "=q2=Raventusk Wraps", ""};
		{ 4, 99999, "", "=q2=Tribal Gage", ""};
		{ 5, 99999, "", "=q2=Snapjaw Shell Gauntlets", ""};
		{ 8, 0, "achievement_character_troll_female", "=q6=#r3#", ""};
		{ 9, 99999, "", "=q2=Leafy Sandals", ""};
		{ 10, 99999, "", "=q2=Gnarled Galoshes", ""};
		{ 11, 99999, "", "=q2=Raventusk Boots", ""};
		{ 12, 99999, "", "=q2=Jungle Sabatons", ""};
		{ 16, 0, "achievement_character_troll_female", "=q6=#r4#", ""};
		{ 17, 99999, "", "=q2=Grassy Girdle", ""};
		{ 18, 99999, "", "=q2=Raventusk Belt", ""};
		{ 19, 99999, "", "=q2=Rustic Tribal Girdle", ""};
		{ 20, 99999, "", "=q2=Village Band", ""};
		{ 21, 99999, "", "=q1=Schematic: Raventusk Disguise", ""};
		{ 23, 0, "achievement_character_troll_female", "=q6=#r5#", ""};
		{ 24, 99999, "", "=q3=Moz´jin´s Cape", ""};
		{ 25, 99999, "", "=q3=Drummer Drape", ""};
		{ 26, 99999, "", "=q3=Second War Shroud", ""};
		{ 27, 99999, "", "=q1=Turtle Egg", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Valorsexp"] = {
		{ 1, 99999, "", "=q1=Expedition Crate", ""};
		{ 2, 99999, "", "=q3=Cenarion Saber", "=ds="..AL["Achievement"], "Expedition Crate"};
		{ 3, 99999, "", "=q3=Cenarion Kodo", "=ds="..AL["Achievement"], "Expedition Crate"};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Sepulcher"] = {
		...
		{ 7, 99999, "", "=q2=Sepulcher Girdle", ""};
		{ 8, 99999, "", "=q2=Sepulcher Cord", ""};
		{ 9, 99999, "", "=q2=Sepulcher Reinforced Belt", ""};
		{ 6, 0, "achievement_character_undead_female", "=q6=#r3#", ""};
		{ 2, 99999, "", "=q2=Sepulcher Mantle", ""};
		{ 3, 99999, "", "=q2=Sepulcher Shoulderpads", ""};
		{ 4, 99999, "", "=q2=Sepulcher Spaulders", ""};
		{ 16, 0, "achievement_character_undead_female", "=q6=#r4#", ""};
		{ 17, 99999, "", "=q2=Auberdine Hood", ""};
		{ 18, 99999, "", "=q2=Auberdine Mask", ""};
		{ 19, 99999, "", "=q2=Auberdine Helmet", ""};
		{ 21, 0, "achievement_character_undead_female", "=q6=#r5#", ""};
		{ 22, 99999, "", "=q3=Sepulcher Signet", ""};
		{ 23, 99999, "", "=q3=Child of Arugal", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Corruptedancient"] = {
		{ 1, 99999, "", "=q3=Enchanted Robe", "", "", ""};
		{ 2, 99999, "", "=q3=Agile Bracers", "", "", ""};
		{ 3, 99999, "", "=q3=Hardened Greaves", "", "", ""};
		{ 4, 99999, "", "=q3=Cloak of the Ancient", "", "", ""};
		{ 5, 99999, "", "=q3=Sparkling Scepter", "=ds=#w12#", "", ""};
		{ 16, 99999, "", "=q1=Heart of the Ancient", "=ds=#m3#", "", ""};
		{ 17, 99999, "", "=q1=Amulet of the Forest", "=q1=#m4#", "", ""};
		Back = "WORLDBOSSMENU";
	};

	AtlasLoot_Data["Gonzor"] = {
		{ 1, 99999, "", "=q3=Abominable Drape", "", "", ""};
		{ 2, 99999, "", "=q3=Sasquatch Signet", "", "", ""};
		{ 3, 99999, "", "=q3=Icy Buckle", "", "", ""};
		{ 4, 99999, "", "=q3=Bigfoot Handguards", "", "", ""};
		{ 5, 99999, "", "=q3=Frostbite Bindings", "", "", ""};
		{ 6, 99999, "", "=q3=Glacial Greatsword", "", "", ""};
		{ 7, 99999, "", "=q3=Avalanche Slicer", "", "", ""};
		{ 8, 99999, "", "=q2=Yeti Crusher", "", "", ""};
		{ 9, 99999, "", "=q3=Gonzor´s Lunch", "", "", ""};
		{ 10, 99999, "", "=q3=Frostbiter", "", "", ""};
		Back = "WORLDBOSSMENU";
	};

	AtlasLoot_Data["Kinggnok"] = {
		{ 1, 99999, "", "=q3=Kingly Pendant", "", "", ""};
		{ 2, 99999, "", "=q3=Wild Tassets", "", "", ""};
		{ 3, 99999, "", "=q3=Jungle Heartguard", "", "", ""};
		{ 4, 99999, "", "=q3=Canopy Shoulders", "", "", ""};
		{ 5, 99999, "", "=q3=Silverback Helm", "", "", ""};
		{ 6, 99999, "", "=q3=Silverback Smasher", "", "", ""};
		{ 7, 99999, "", "=q3=Jungle Channeler", "", "", ""};
		{ 8, 99999, "", "=q3=King´s Shot", "", "", ""};
		{ 9, 99999, "", "=q3=Thunderous Roar", "", "", ""};
		{ 10, 99999, "", "=q3=Vineblade", "", "", ""};
		Back = "WORLDBOSSMENU";
	};

	AtlasLoot_Data["Silithidlurker"] = {
		{ 1, 99999, "", "=q3=Duskwalker Turban", "=ds=#s1#", "", ""};
		{ 2, 99999, "", "=q3=Jewel of the Lurker", "=ds=#s2#", "", ""};
		{ 3, 99999, "", "=q3=Sandwalker Gauntlets", "=ds=#s9#", "", ""};
		{ 4, 99999, "", "=q3=Infested Boots", "=ds=#s11#", "", ""};
		{ 5, 99999, "", "=q3=Lurker´s Brood", "=ds=#s14#"};
		{ 6, 99999, "", "=q3=Silithid Poker", "", "", ""};
		Back = "WORLDBOSSMENU";
	};

	AtlasLoot_Data["Volchan"] = {
		{ 1, 99999, "", "=q4=Wildfire Chain Shoulders", "=ds=#s3#", "", ""};
		{ 2, 99999, "", "=q4=Cloak of Convalescence", "=ds=#s4#", "", ""};
		{ 3, 99999, "", "=q4=Crossfire Shoulderguards", "=ds=#s3#", "", ""};
		{ 4, 99999, "", "=q4=Flame-Tempered Shoulderplates", "=ds=#s3#", "", ""};
		{ 5, 99999, "", "=q4=Living Spark Spaulders", "=ds=#s3#", "", ""};
		{ 6, 99999, "", "=q4=Mantle of the Royal Flame", "=ds=#s3#", "", ""};
		{ 7, 99999, "", "=q4=Mountain Breaker", "=ds=#w6#", "", ""};
		{ 8, 99999, "", "=q4=Pyrite-Studded Chain Epaulets", "=ds=#s3#", "", ""};
		{ 9, 99999, "", "=q4=Seethe", "=ds=#w4#", "", ""};
		Back = "WORLDBOSSMENU";
	};
	...
	AtlasLoot_Data["Tabards1"] = {
		...
		{ 10, 99999, "", "=q2=Tailor´s Apron", "=ds=#s7#"};
		{ 11, 99999, "", "=q2=Enchanter´s Apron", "=ds=#s7#"};
		{ 12, 99999, "", "=q2=Leatherworker´s Apron", "=ds=#s7#"};
		{ 13, 99999, "", "=q2=Blacksmith´s Apron", "=ds=#s7#"};
		{ 14, 99999, "", "=q2=Alchemist´s Apron", "=ds=#s7#"};
		{ 15, 99999, "", "=q2=Engineer´s Apron", "=ds=#s7#"};
		{ 25, 99999, "", "=q2=Chef´s Apron", "=ds=#s7#"};
		{ 26, 99999, "", "=q2=Skinner´s Apron", "=ds=#s7#"};
		{ 27, 99999, "", "=q2=Miner´s Apron", "=ds=#s7#"};
		{ 28, 99999, "", "=q2=Herbalist´s Apron", "=ds=#s7#"};
		{ 29, 99999, "", "=q2=Angler´s Apron", "=ds=#s7#"};
	...
	AtlasLoot_Data["PetsMerchant1"] = {
		...
		{ 20, 99999, "", "=q2=Alliance Balloon", "=ds=World PVP Vendor", "1 #epvpw#", ""};
		{ 21, 99999, "", "=q2=Horde Balloon", "=ds=World PVP Vendor", "1 #epvpw#", ""};
		Next = "PetsDrop1";
		Back = "PETMENU";
	};
