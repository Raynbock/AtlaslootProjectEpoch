...
---- Azuregos
	...
	AtlasLoot_Data["Glittermurk"] = {
		...
		{ 5, 0, "INV_Box_01", "=q6="..BabbleEpoch["Miner Davod"], ""};
		{ 6, 61007, "", "=q3=Davod´s Lantern", "", "", ""};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleEpoch["Foreman Sprocket"], ""};
		{ 9, 60986, "", "=q3=Heavy Metal Belt", "", "", ""};
		{ 10, 60997, "", "=q3=Throwing ´Saws´", "", "", ""};
		{ 11, 60991, "", "=q3=Shredder Spaulders", "", "", ""};
		{ 12, 60995, "", "=q3=Steel Pickaxe", "", "", ""};
	...
	AtlasLoot_Data["Maraudon1"] = {
		...
		{ 23, 61094, "", "=q3=Fungus Infused Belt", "", "", ""};
		{ 24, 17741, "", "=q3=Nature's Embrace", "=ds=#s5#, #a1#", "", "30.34%"};
		{ 25, 17742, "", "=q3=Fungus Shroud Armor", "=ds=#s5#, #a2#", "", "31.37%"};
		{ 26, 17767, "", "=q3=Bloomsprout Headpiece", "=ds=#s1#, #a3#", "", "28.32%"};
		Next = "Maraudon2";
	};
	...
	AtlasLoot_Data["ZFHydromancerVelratha"] = {
		{ 1, 61055, "", "=q3=Sandfury Slippers", "", "", ""};
		{ 2, 61054, "", "=q3=Sacred Helm", "=ds=#s1#", "", ""};
	...
	AtlasLoot_Data["Combatantfep1"] = {
		{ 1, 61410, "", "=q3=SetItem", "", "", ""};
		{ 2, 61412, "", "=q3=SetItem", "", "", ""};
		Back = "EPOCHSETMENU";
	};

	AtlasLoot_Data["Honorableep1"] = {
		{ 1, 60721, "", "=q3=SetItem", "", "", ""};
		{ 2, 60723, "", "=q3=SetItem", "", "", ""};
		{ 16, 60736, "", "=q3=SetItem", "", "", ""};
		{ 17, 60737, "", "=q3=SetItem", "", "", ""};
	...
	AtlasLoot_Data["PvP60Accessories1_A"] = {
		{ 1, 18243, "", "=q4=Black Battlestrider", "=ds=#e12#", "50000 #alliance#", ""};
		{ 2, 18244, "", "=q4=Black War Ram", "=ds=#e12#", "50000 #alliance#", ""};
		{ 3, 18241, "", "=q4=Black War Steed Bridle", "=ds=#e12#", "50000 #alliance#", ""};
		{ 4, 18242, "", "=q4=Reins of the Black War Tiger", "=ds=#e12#", "50000 #alliance#", ""};
		{ 6, 18863, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 7, 18856, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 8, 18859, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 9, 18864, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 10, 18862, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 11, 18857, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 12, 18858, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
		{ 13, 18854, "", "=q3=Insignia of the Alliance", "=ds=#s14#", "2805 #alliance#", ""};
	...
	AtlasLoot_Data["PvP60Accessories1_H"] = {
		{ 1, 18247, "", "=q4=Black War Kodo", "=ds=#e12#", "50000 #horde#", ""};
		{ 2, 18245, "", "=q4=Horn of the Black War Wolf", "=ds=#e12#", "50000 #horde#", ""};
		{ 3, 18248, "", "=q4=Red Skeletal Warhorse", "=ds=#e12#", "50000 #horde#", ""};
		{ 4, 18246, "", "=q4=Whistle of the Black War Raptor", "=ds=#e12#", "50000 #horde#", ""};
		{ 6, 18853, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 7, 18846, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 8, 18850, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 9, 18851, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 10, 18849, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 11, 18845, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 12, 18852, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
		{ 13, 18834, "", "=q3=Insignia of the Horde", "=ds=#s14#", "2805 #horde#", ""};
	...
	AtlasLoot_Data["WildhammerClan"] = {
		...
		{ 26, 49662, "inv_misc_pet_02", "=q1=Gryphon Hatchling", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Corruptedancient"] = {
		...
		{ 2, 61130, "", "=q3=Sparkling Scepter", "=ds=#w12#", "", ""};
	...
	AtlasLoot_Data["Silithidlurker"] = {
		...
		{ 5, 61136, "", "=q3=Lurker´s Brood", "=ds=#s14#: =ds=#s2#"};
	};
