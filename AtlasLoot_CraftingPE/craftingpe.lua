...
---- Crafted Epic Weapons
	...
	AtlasLoot_Data["AlchemyBattleElixir1"] = {
		...
		{ 12, "s63732", "45621", "=q1=Elixir of Accuracy", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["AlchemyGuardianElixir1"] = {
		...
		{ 7, "s3450", "3825", "=q1=Elixir of Fortitude", "=ds="..AL["Trainer"]};
		{ 8, "s3177", "3389", "=q1=Elixir of Defense", "=ds="..AL["Trainer"]};
		{ 9, "s3176", "3388", "=q1=Strong Troll's Blood Potion", "=ds="..AL["Trainer"]};
		{ 10, "s3171", "3383", "=q1=Elixir of Wisdom", "=ds="..AL["Trainer"]};
		{ 11, "s2334", "2458", "=q1=Elixir of Minor Fortitude", "=ds="..AL["Trainer"]};
		{ 12, "s3170", "3382", "=q1=Weak Troll's Blood Elixir", "=ds="..AL["Trainer"]};
		{ 13, "s7183", "5997", "=q1=Elixir of Minor Defense", "=ds="..AL["Trainer"]};
		Next = "AlchemyPotion1";
	...
	AtlasLoot_Data["AlchemyPotion1"] = {
		...
		{ 15, "s11458", "9144", "=q1=Wildvine Potion", "=ds="..BabbleZone["The Hinterlands"].."/"..BabbleZone["Stranglethorn Vale"]};
		{ 16, "s4942", "4623", "=q1=Lesser Stoneshield Potion", "=ds="..AL["Quest"]..": "..BabbleZone["Badlands"]};
		{ 17, "s11457", "3928", "=q1=Superior Healing Potion", "=ds="..AL["Trainer"]};
		{ 18, "s11453", "9036", "=q1=Magic Resistance Potion", "=ds="..AL["World Drop"]};
		{ 19, "s11452", "9030", "=q1=Restorative Potion", "=ds="..AL["Quest"]..": "..BabbleZone["Badlands"]};
		{ 20, "s11448", "6149", "=q1=Greater Mana Potion", "=ds="..AL["Trainer"]};
		{ 21, "s7258", "6050", "=q1=Frost Protection Potion", "=ds="..AL["Achievement"], "Vendor:Arathi(A)/Booty Bay(A/H)"};
		{ 22, "s7259", "6052", "=q1=Nature Protection Potion", "=ds="..AL["Achievement"], "Vendor:Booty Bay/Gadgetzan"};
		{ 23, "s6618", "5633", "=q1=Great Rage Potion", "=ds="..BabbleZone["Orgrimmar"].."/"..BabbleZone["Darnassus"]};
		{ 24, "s3448", "3823", "=q1=Lesser Invisibility Potion", "=ds="..AL["Trainer"]};
		{ 25, "s7257", "6049", "=q1=Fire Protection Potion", "=ds="..AL["Achievement"], "Southshore(A) - Sunrock Retreat(H)"};
		{ 26, "s3452", "3827", "=q1=Mana Potion", "=ds="..AL["Trainer"]};
		{ 27, "s7181", "1710", "=q1=Greater Healing Potion", "=ds="..AL["Trainer"]};
		{ 28, "s6624", "5634", "=q1=Free Action Potion", "=ds="..BabbleZone["Orgrimmar"].."/"..BabbleZone["Ironforge"]};
		{ 29, "s7256", "6048", "=q1=Shadow Protection Potion", "=ds="..AL["Achievement"], "Ashenvale South(A) - Tarren Mill(H)"};
		{ 30, "s3173", "3385", "=q1=Lesser Mana Potion", "=ds="..AL["Trainer"]};
		Next = "AlchemyPotion2";
	...
	AtlasLoot_Data["AlchemyPotion2"] = {
		{ 1, "s3174", "3386", "=q1=Potion of Curing", "=ds="..AL["World Drop"]};
		{ 2, "s3447", "929", "=q1=Healing Potion", "=ds="..AL["Trainer"]};
		{ 3, "s3172", "3384", "=q1=Minor Magic Resistance Potion", "=ds="..AL["World Drop"]};
		{ 4, "s7255", "6051", "=q1=Holy Protection Potion", "=ds="..AL["Achievement"], "Duskwood(A/H) - Crossroads(H)"};
		{ 5, "s7841", "6372", "=q1=Swim Speed Potion", "=ds="..AL["Trainer"]};
		{ 6, "s6617", "5631", "=q1=Rage Potion", "=ds="..AL["Achievement"], "Moonbrook(A/H)Ratchet"};
		{ 7, "s2335", "2459", "=q1=Swiftness Potion", "=ds="..AL["World Drop"]};
		{ 8, "s2337", "858", "=q1=Lesser Healing Potion", "=ds="..AL["Trainer"]};
		{ 9, "s4508", "4596", "=q1=Discolored Healing Potion", "=ds="..AL["Quest"]..", "..BabbleZone["Silverpine Forest"]};
		{ 10, "s2332", "2456", "=q1=Minor Rejuvenation Potion", "=ds="..AL["Trainer"]};
		{ 11, "s2331", "2455", "=q1=Minor Mana Potion", "=ds="..AL["Trainer"]};
		{ 12, "s2330", "118", "=q1=Minor Healing Potion", "=ds="..AL["Trainer"]};
		Next = "AlchemyFlask1";
		Prev = "AlchemyPotion1";
		Back = "ALCHEMYMENU";
	};
	...
	AtlasLoot_Data["AlchemyTransmute1"] = {
		...
		{ 12, "s25146", "7068", "=q1=Transmute: Elemental Fire", "=ds="..AL["Achievement"], "BRD-Thorium Brotherhood Friendly"};
		Next = "AlchemyMisc1";
		Prev = "AlchemyFlask1";
		Back = "ALCHEMYMENU";
	};
	...
	AtlasLoot_Data["AlchemyMisc1"] = {
		...
		{ 9, "s3449", "3824", "=q1=Shadow Oil", "=ds="..AL["Achievement"], "Ravenhill Duskwood-Freewind Post(H)"};
		{ 10, "s7179", "5996", "=q1=Elixir of Water Breathing", "=ds="..AL["Trainer"]};
		{ 11, "s17551", "13423", "=q1=Stonescale Oil", "=ds="..AL["Trainer"]};
		{ 12, "s11473", "9210", "=q1=Ghost Dye", "=ds="..AL["Vendor"]..", "..BabbleZone["Feralas"]};
		{ 13, "s11456", "9061", "=q1=Goblin Rocket Fuel", "=ds="..AL["Crafted"]..": "..GetSpellInfo(4036)};
		{ 14, "s11459", "9149", "=q1=Philosopher's Stone", "=ds="..AL["Vendor"]..", "..BabbleZone["Tanaris"]};
		{ 15, "s7837", "6371", "=q1=Fire Oil", "=ds="..AL["Trainer"]};
		{ 16, "s7836", "6370", "=q1=Blackmouth Oil", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["SmithingArmorOld1"] = {
		...
		{ 3, "s16660", "12625", "=q3=Dawnbringer Shoulders", "=ds=#sr# 290"};
		{ 4, "s23632", "19051", "=q3=Girdle of the Dawn", "=ds=#sr# 290"};
		{ 5, "s23628", "19043", "=q3=Heavy Timbermaw Belt", "=ds=#sr# 290"};
		{ 6, "s3508", "3844", "=q3=Green Iron Hauberk", "=ds=#sr# 180"};
		{ 7, "s2675", "2870", "=q3=Shining Silver Breastplate", "=ds=#sr# 145"};
		{ 8, "s16663", "12422", "=q2=Imperial Plate Chest", "=ds=#sr# 300"};
		{ 9, "s16730", "12429", "=q2=Imperial Plate Leggings", "=ds=#sr# 300"};
		{ 10, "s16725", "12420", "=q2=Radiant Leggings", "=ds=#sr# 300"};
		{ 11, "s16731", "12613", "=q2=Runic Breastplate", "=ds="..AL["Drop"]..""};
		{ 12, "s16665", "12611", "=q2=Runic Plate Boots", "=ds=#sr# 300"};
		{ 13, "s16732", "12614", "=q2=Runic Plate Leggings", "=ds=#sr# 300"};
		{ 14, "s16726", "12612", "=q2=Runic Plate Helm", "=ds="..AL["Drop"]..""};
		{ 15, "s16726", "12612", "=q2=Runic Plate Helm", "=ds="..AL["Drop"]..""};
		{ 16, "s16664", "12610", "=q2=Runic Plate Shoulders", "=ds=#sr# 300"};
		{ 17, "s16662", "12414", "=q2=Thorium Leggings", "=ds=#sr# 300"};
		{ 18, "s16657", "12426", "=q2=Imperial Plate Boots", "=ds=#sr# 295"};
		{ 19, "s16658", "12427", "=q2=Imperial Plate Helm", "=ds=#sr# 295"};
		{ 20, "s16659", "12417", "=q2=Radiant Circlet", "=ds=#sr# 295"};
		{ 21, "s16656", "12419", "=q2=Radiant Boots", "=ds=#sr# 290"};
		{ 22, "s16654", "12418", "=q2=Radiant Gloves", "=ds=#sr# 285"};
		{ 23, "s16652", "12409", "=q2=Thorium Boots", "=ds=#sr# 280"};
		{ 24, "s16653", "12410", "=q2=Thorium Helm", "=ds=#sr# 280"};
		{ 25, "s15295", "11605", "=q2=Dark Iron Shoulders", "=ds=#sr# 280"};
		{ 26, "s15293", "11606", "=q2=Dark Iron Mail", "=ds=#sr# 270"};
		{ 27, "s16649", "12425", "=q2=Imperial Plate Bracers", "=ds=#sr# 270"};
		{ 28, "s16648", "12415", "=q2=Radiant Breastplate", "=ds=#sr# 270"};
		{ 29, "s16647", "12424", "=q2=Imperial Plate Belt", "=ds=#sr# 265"};
		{ 30, "s16646", "12428", "=q2=Imperial Plate Shoulders", "=ds=#sr# 265"};
		Next = "SmithingArmorOld2";
		Back = "SMITHINGMENU";
	};

	AtlasLoot_Data["SmithingArmorOld2"] = {
		{ 1, "s9979", "7936", "=q2=Ornate Mithril Boots", "=ds="..AL["Quest"]..""};
		{ 2, "s9972", "7935", "=q2=Ornate Mithril Breastplate", "=ds="..AL["Quest"]..""};
		{ 3, "s9980", "7937", "=q2=Ornate Mithril Helm", "=ds="..AL["Quest"]..""};
		{ 4, "s16645", "12416", "=q2=Radiant Belt", "=ds=#sr# 260"};
		{ 5, "s16644", "12408", "=q2=Thorium Bracers", "=ds=#sr# 255"};
		{ 6, "s16642", "12405", "=q2=Thorium Armor", "=ds=#sr# 250"};
		{ 7, "s16643", "12406", "=q2=Thorium Belt", "=ds=#sr# 250"};
		{ 8, "s9970", "7934", "=q2=Heavy Mithril Helm", "=ds=#sr# 245"};
		{ 9, "s9966", "7932", "=q2=Mithril Scale Shoulders", "=ds=#sr# 235"};
		{ 10, "s9968", "7933", "=q2=Heavy Mithril Boots", "=ds=#sr# 235"};
		{ 11, "s9959", "7930", "=q2=Heavy Mithril Breastplate", "=ds=#sr# 230"};
		{ 12, "s9961", "7931", "=q2=Mithril Coif", "=ds=#sr# 230"};
		{ 13, "s9952", "7928", "=q2=Ornate Mithril Shoulder", "=ds=#sr# 225"};
		{ 14, "s9950", "7927", "=q2=Ornate Mithril Gloves", "=ds=#sr# 220"};
		{ 15, "s9945", "7926", "=q2=Ornate Mithril Pants", "=ds=#sr# 220"};
		{ 16, "s9937", "7924", "=q2=Mithril Scale Bracers", "=ds=#sr# 215"};
		{ 17, "s9931", "7920", "=q2=Mithril Scale Pants", "=ds=#sr# 210"};
		{ 18, "s9933", "7921", "=q2=Heavy Mithril Pants", "=ds=#sr# 210"};
		{ 19, "s9957", "7929", "=q2=Orcish War Leggings", "=ds="..AL["Quest"]..""};
		{ 20, "s9928", "7919", "=q2=Heavy Mithril Gauntlet", "=ds=#sr# 205"};
		{ 21, "s9926", "7918", "=q2=Heavy Mithril Shoulder", "=ds=#sr# 205"};
		{ 22, "s11643", "9366", "=q2=Golden Scale Gauntlets", "=ds=#sr# 205"};
		{ 23, "s9916", "7963", "=q2=Steel Breastplate", "=ds=#sr# 200"};
		{ 24, "s3515", "3847", "=q2=Golden Scale Boots", "=ds=#sr# 200"};
		{ 25, "s3511", "3845", "=q2=Golden Scale Cuirass", "=ds=#sr# 195"};
		{ 26, "s3503", "3837", "=q2=Golden Scale Coif", "=ds=#sr# 190"};
		{ 27, "s3513", "3846", "=q2=Polished Steel Boots", "=ds=#sr# 185"};
		{ 28, "s9820", "7917", "=q2=Barbaric Iron Gloves", "=ds=#sr# 185"};
		{ 29, "s9818", "7916", "=q2=Barbaric Iron Boots", "=ds=#sr# 180"};
		{ 30, "s9814", "7915", "=q2=Barbaric Iron Helm", "=ds=#sr# 175"};
	...
	AtlasLoot_Data["SmithingArmorOld3"] = {
		{ 1, "s3505", "3841", "=q2=Golden Scale Shoulders", "=ds=#sr# 175"};
		{ 2, "s3507", "3843", "=q2=Golden Scale Leggings", "=ds=#sr# 170"};
		{ 3, "s3502", "3836", "=q2=Green Iron Helm", "=ds=#sr# 170"};
		{ 4, "s9813", "7914", "=q2=Barbaric Iron Breastplate", "=ds=#sr# 160"};
		{ 5, "s9811", "7913", "=q2=Barbaric Iron Shoulders", "=ds=#sr# 160"};
		{ 6, "s3504", "3840", "=q2=Green Iron Shoulders", "=ds=#sr# 160"};
		{ 7, "s3506", "3842", "=q2=Green Iron Leggings", "=ds=#sr# 155"};
		{ 8, "s12259", "10423", "=q2=Silvered Bronze Leggings", "=ds=#sr# 155"};
		{ 9, "s3336", "3485", "=q2=Green Iron Gauntlets", "=ds=#sr# 150"};
		{ 10, "s3334", "3484", "=q2=Green Iron Boots", "=ds=#sr# 145"};
		{ 11, "s3333", "3483", "=q2=Silvered Bronze Gauntlets", "=ds=#sr# 135"};
		{ 12, "s3331", "3482", "=q2=Silvered Bronze Boots", "=ds=#sr# 130"};
		{ 13, "s2673", "2869", "=q2=Silvered Bronze Breastplate", "=ds=#sr# 130"};
		{ 14, "s3330", "3481", "=q2=Silvered Bronze Shoulders", "=ds=#sr# 125"};
		{ 15, "s2672", "2868", "=q2=Patterned Bronze Bracers", "=ds=#sr# 120"};
		{ 16, "s2668", "2865", "=q2=Rough Bronze Leggings", "=ds=#sr# 105"};
		{ 17, "s8367", "6731", "=q2=Ironforge Breastplate", "=ds=#sr# 100"};
		{ 18, "s2667", "2864", "=q2=Runed Copper Breastplate", "=ds=#sr# 80"};
		{ 19, "s3325", "3474", "=q2=Gemmed Copper Gauntlets", "=ds=#sr# 60"};
		{ 20, "s3324", "3473", "=q2=Runed Copper Pants", "=ds=#sr# 45"};
		{ 21, "s3321", "3471", "=q2=Copper Chain Vest", "=ds=#sr# 35"};
		{ 22, "s9935", "7922", "=q1=Steel Plate Helm", "=ds=#sr# 215"};
		{ 23, "s7223", "6040", "=q1=Golden Scale Bracers", "=ds=#sr# 185"};
		{ 24, "s3501", "3835", "=q1=Green Iron Bracers", "=ds=#sr# 165"};
		{ 25, "s3328", "3480", "=q1=Rough Bronze Shoulders", "=ds=#sr# 110"};
		{ 26, "s2670", "2866", "=q1=Rough Bronze Cuirass", "=ds=#sr# 105"};
		{ 27, "s7817", "6350", "=q1=Rough Bronze Boots", "=ds=#sr# 95"};
		{ 28, "s2664", "2854", "=q1=Runed Copper Bracers", "=ds=#sr# 90"};
		{ 29, "s2666", "2857", "=q1=Runed Copper Belt", "=ds=#sr# 70"};
		{ 30, "s3323", "3472", "=q1=Runed Copper Gauntlets", "=ds=#sr# 40"};
	...
	AtlasLoot_Data["SmithingArmorOld4"] = {
		{ 1, "s2661", "2851", "=q1=Copper Chain Belt", "=ds=#sr# 35"};
		{ 2, "s3319", "3469", "=q1=Copper Chain Boots", "=ds=#sr# 20"};
		{ 3, "s2663", "2853", "=q1=Copper Bracers", "=ds=#sr# 1"};
		{ 4, "s2662", "2852", "=q1=Copper Chain Pants", "=ds=#sr# 1"};
		{ 5, "s12260", "10421", "=q1=Rough Copper Vest", "=ds=#sr# 1"};
		Prev = "SmithingArmorOld3";
		Back = "SMITHINGMENU";
	};

	AtlasLoot_Data["SmithingWeaponOld1"] = {
		{ 1, "s34982", "29203", "=q2=Enchanted Thorium Blades", "=ds=#sr# 300"};
		{ 2, "s16984", "12792", "=q2=Volcanic Hammer", "=ds=#sr# 290"};
		{ 3, "s16971", "12775", "=q2=Huge Thorium Battleaxe", "=ds=#sr# 280"};
		{ 4, "s16969", "12773", "=q2=Ornate Thorium Handaxe", "=ds=#sr# 275"};
		{ 5, "s10013", "7947", "=q2=Ebon Shiv", "=ds=#sr# 255"};
		{ 6, "s10009", "7946", "=q2=Runed Mithril Hammer", "=ds=#sr# 245"};
		{ 7, "s10005", "7944", "=q2=Dazzling Mithril Rapier", "=ds=#sr# 240"};
		{ 8, "s10001", "7945", "=q2=Big Black Mace", "=ds=#sr# 230"};
		{ 9, "s9997", "7943", "=q2=Wicked Mithril Blade", "=ds=#sr# 225"};
		{ 10, "s9995", "7942", "=q2=Blue Glittering Axe", "=ds=#sr# 220"};
		{ 11, "s9993", "7941", "=q2=Heavy Mithril Axe", "=ds=#sr# 210"};
		{ 12, "s3500", "3856", "=q2=Shadow Crescent Axe", "=ds=#sr# 200"};
		{ 13, "s34981", "29202", "=q2=Whirling Steel Axes", "=ds=#sr# 200"};
		{ 14, "s3497", "3854", "=q2=Frost Tiger Blade", "=ds=#sr# 200"};
		{ 15, "s15973", "12260", "=q2=Searing Golden Blade", "=ds=#sr# 190"};
		{ 16, "s21913", "17704", "=q2=Edge of Winter", "=ds=#sr# 190"};
		{ 17, "s3498", "3855", "=q2=Massive Iron Axe", "=ds=#sr# 185"};
		{ 18, "s15972", "12259", "=q2=Glinting Steel Dagger", "=ds=#sr# 180"};
		{ 19, "s3496", "3853", "=q2=Moonsteel Broadsword", "=ds=#sr# 180"};
		{ 20, "s3493", "3850", "=q2=Jade Serpentblade", "=ds=#sr# 175"};
		{ 21, "s3495", "3852", "=q2=Golden Iron Destroyer", "=ds=#sr# 170"};
		{ 22, "s3492", "3849", "=q2=Hardened Iron Shortsword", "=ds=#sr# 160"};
		{ 23, "s3494", "3851", "=q2=Solid Iron Maul", "=ds=#sr# 155"};
		{ 24, "s3297", "3492", "=q2=Mighty Iron Hammer", "=ds=#sr# 145"};
		{ 25, "s6518", "5541", "=q2=Iridescent Hammer", "=ds=#sr# 140"};
		{ 26, "s3296", "3491", "=q2=Heavy Bronze Mace", "=ds=#sr# 130"};
		{ 27, "s3295", "3490", "=q2=Deadly Bronze Poniard", "=ds=#sr# 125"};
		{ 28, "s6517", "5540", "=q2=Pearl-handled Dagger", "=ds=#sr# 110"};
		{ 29, "s3491", "3848", "=q2=Big Bronze Knife", "=ds=#sr# 105"};
		{ 30, "s34979", "29201", "=q2=Thick Bronze Darts", "=ds=#sr# 100"};
		Next = "SmithingWeaponOld2";
		Back = "SMITHINGMENU";
	};

	AtlasLoot_Data["SmithingWeaponOld2"] = {
		{ 1, "s3292", "3487", "=q2=Heavy Copper Broadsword", "=ds=#sr# 95"};
		{ 2, "s3294", "3489", "=q2=Thick War Axe", "=ds=#sr# 70"};
		{ 3, "s3293", "3488", "=q2=Copper Battle Axe", "=ds=#sr# 35"};
		{ 4, "s43549", "33791", "=q2=Heavy Copper Longsword", "=ds=#sr# 35"};
		{ 5, "s9987", "7958", "=q1=Bronze Battle Axe", "=ds=#sr# 135"};
		{ 6, "s9986", "7957", "=q1=Bronze Greatsword", "=ds=#sr# 130"};
		{ 7, "s9985", "7956", "=q1=Bronze Warhammer", "=ds=#sr# 125"};
		{ 8, "s2742", "2850", "=q1=Bronze Shortsword", "=ds=#sr# 120"};
		{ 9, "s2741", "2849", "=q1=Bronze Axe", "=ds=#sr# 115"};
		{ 10, "s2740", "2848", "=q1=Bronze Mace", "=ds=#sr# 110"};
		{ 11, "s7408", "6214", "=q1=Heavy Copper Maul", "=ds=#sr# 65"};
		{ 12, "s9983", "7955", "=q1=Copper Claymore", "=ds=#sr# 30"};
		{ 13, "s8880", "7166", "=q1=Copper Dagger", "=ds=#sr# 30"};
		{ 14, "s2739", "2847", "=q1=Copper Shortsword", "=ds=#sr# 25"};
	...
	AtlasLoot_Data["SmithingEnhancement1"] = {
		{ 3, "s16651", "12645", "=q2=Thorium Shield Spike", "=ds=#sr# 275"};
		{ 1, "s9964", "7969", "=q2=Mithril Spurs", "=ds=#sr# 235"};
		{ 4, "s9939", "7967", "=q2=Mithril Shield Spike", "=ds=#sr# 215"};
		{ 21, "s16641", "12404", "=q1=Dense Sharpening Stone", "=ds=#sr# 250"};
		{ 16, "s16640", "12643", "=q1=Dense Weightstone", "=ds=#sr# 250"};
		{ 22, "s9918", "7964", "=q1=Solid Sharpening Stone", "=ds=#sr# 200"};
		{ 17, "s9921", "7965", "=q1=Solid Weightstone", "=ds=#sr# 200"};
		{ 7, "s7224", "6041", "=q1=Steel Weapon Chain", "=ds=#sr# 190"};
		{ 8, "s7222", "6043", "=q1=Iron Counterweight", "=ds=#sr# 165"};
		{ 5, "s7221", "6042", "=q1=Iron Shield Spike", "=ds=#sr# 150"};
		{ 23, "s2674", "2871", "=q1=Heavy Sharpening Stone", "=ds=#sr# 125"};
		{ 18, "s3117", "3241", "=q1=Heavy Weightstone", "=ds=#sr# 125"};
		{ 24, "s2665", "2863", "=q1=Coarse Sharpening Stone", "=ds=#sr# 65"};
		{ 19, "s3116", "3240", "=q1=Coarse Weightstone", "=ds=#sr# 65"};
		{ 25, "s2660", "2862", "=q1=Rough Sharpening Stone", "=ds=#sr# 1"};
		{ 20, "s3115", "3239", "=q1=Rough Weightstone", "=ds=#sr# 1"};
		Back = "SMITHINGMENU";
	};
	...
	AtlasLoot_Data["SmithingMisc1"] = {
		...
		{ 5, "s20201", "16206", "=q1=Arcanite Rod", "=ds=#sr# 275"};
		{ 6, "s16639", "12644", "=q1=Dense Grinding Stone", "=ds=#sr# 250"};
		{ 7, "s11454", "9060", "=q1=Inlaid Mithril Cylinder", "=ds=#sr# 200"};
		{ 8, "s14380", "11144", "=q1=Truesilver Rod", "=ds=#sr# 200"};
		{ 9, "s9920", "7966", "=q1=Solid Grinding Stone", "=ds=#sr# 200"};
		{ 10, "s14379", "11128", "=q1=Golden Rod", "=ds=#sr# 150"};
		{ 11, "s8768", "7071", "=q1=Iron Buckle", "=ds=#sr# 150"};
		{ 12, "s3337", "3486", "=q1=Heavy Grinding Stone", "=ds=#sr# 125"};
		{ 13, "s7818", "6338", "=q1=Silver Rod", "=ds=#sr# 100"};
		{ 14, "s3326", "3478", "=q1=Coarse Grinding Stone", "=ds=#sr# 75"};
		{ 15, "s3320", "3470", "=q1=Rough Grinding Stone", "=ds=#sr# 25"};
		Back = "SMITHINGMENU";
	};
	...
	AtlasLoot_Data["EnchantingRing1"] = {
		{ 1, "s446457", "Spell_Holy_GreaterHeal", "=ds=Under Construction", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["EnchantingMisc1"] = {
		{ 1, "s15596", "11811", "=q3=Smoking Heart of the Mountain", "=ds=#sr# 265"};
		{ 2, "s14810", "11290", "=q2=Greater Mystic Wand", "=ds=#sr# 175"};
		{ 3, "s14809", "11289", "=q2=Lesser Mystic Wand", "=ds=#sr# 155"};
		{ 4, "s14807", "11288", "=q2=Greater Magic Wand", "=ds=#sr# 70"};
		{ 5, "s14293", "11287", "=q2=Lesser Magic Wand", "=ds=#sr# 10"};
		{ 26, "s20051", "16207", "=q1=Runed Arcanite Rod", "=ds=#sr# 290"};
		{ 16, "s25128", "20750", "=q1=Wizard Oil", "=ds=#sr# 275"};
		{ 6, "s17180", "12655", "=q1=Enchanted Thorium", "=ds=#sr# 250"};
		{ 17, "s25127", "20747", "=q1=Lesser Mana Oil", "=ds=#sr# 250"};
		{ 7, "s17181", "12810", "=q1=Enchanted Leather", "=ds=#sr# 250"};
		{ 18, "s25126", "20746", "=q1=Lesser Wizard Oil", "=ds=#sr# 200"};
		{ 27, "s13702", "11145", "=q1=Runed Truesilver Rod", "=ds=#sr# 200"};
		{ 19, "s25125", "20745", "=q1=Minor Mana Oil", "=ds=#sr# 150"};
		{ 28, "s13628", "11130", "=q1=Runed Golden Rod", "=ds=#sr# 150"};
		{ 29, "s7795", "6339", "=q1=Runed Silver Rod", "=ds=#sr# 100"};
		{ 20, "s25124", "20744", "=q1=Minor Wizard Oil", "=ds=#sr# 45"};
	...
	AtlasLoot_Data["LeatherBagsMisc1"] = {
	...
	AtlasLoot_Data["Mining1"] = {
		...
		{ 3, "s14891", "11371", "=q1=Smelt Dark Iron", "=ds=#sr# 230"};
		{ 4, "s10098", "6037", "=q2=Smelt Truesilver", "=ds=#sr# 230"};
		{ 5, "s10097", "3860", "=q1=Smelt Mithril", "=ds=#sr# 175"};
		{ 6, "s3569", "3859", "=q1=Smelt Steel", "=ds=#sr# 165"};
		{ 7, "s3308", "3577", "=q2=Smelt Gold", "=ds=#sr# 155"};
		{ 8, "s3307", "3575", "=q1=Smelt Iron", "=ds=#sr# 125"};
		{ 9, "s2658", "2842", "=q2=Smelt Silver", "=ds=#sr# 75"};
		{ 10, "s2659", "2841", "=q1=Smelt Bronze", "=ds=#sr# 65"};
		{ 11, "s3304", "3576", "=q1=Smelt Tin", "=ds=#sr# 65"};
		{ 12, "s2657", "2840", "=q1=Smelt Copper", "=ds=#sr# 1"};
		{ 17, 10620, "", "=q1=Thorium Ore", "=ds=#sr# 245"};
		{ 18, 11370, "", "=q1=Dark Iron Ore", "=ds=#sr# 230"};
		{ 19, 7911, "", "=q2=Truesilver Ore", "=ds=#sr# 230"};
		{ 20, 3858, "", "=q1=Mithril Ore", "=ds=#sr# 175"};
		{ 21, 2776, "", "=q2=Gold Ore", "=ds=#sr# 155"};
		{ 22, 2772, "", "=q1=Iron Ore", "=ds=#sr# 125"};
		{ 23, 2775, "", "=q2=Silver Ore", "=ds=#sr# 75"};
		{ 24, 2771, "", "=q1=Tin Ore", "=ds=#sr# 65"};
	...
	AtlasLoot_Data["TailoringBags1"] = {
		...
		{ 13, "s6688", "5763", "=q1=Red Woolen Bag", "=ds=#sr# 115"};
		{ 14, "s3758", "4241", "=q1=Green Woolen Bag", "=ds=#sr# 95"};
		{ 15, "s3757", "4240", "=q1=Woolen Bag", "=ds=#sr# 80"};
		{ 16, "s6686", "5762", "=q1=Red Linen Bag", "=ds=#sr# 70"};
	...
	AtlasLoot_Data["TailoringMisc1"] = {
		{ 1, "s99999", "99999", "=q4=Enchants coming here soon", "=ds=#sr# 300"};
		Back = "TAILORINGMENU";
	};
	...
	AtlasLoot_Data["CraftedWeapons1"] = {
		...
		{ 2, 22383, "", "=q4=Sageblade", "=ds=#h3#, #w10#"};
		{ 3, 22384, "", "=q4=Persuader", "=ds=#h1#, #w6#"};
		Back = "CRAFTINGMENU";
	};
