...
------------
  ...
  -- Vanilla WoW Sets
	AtlasLoot_TableNames["Epochset"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["Epochsetz"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz2"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz3"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz4"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz5"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz6"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Epochsetz7"] = { BabbleEpoch["Epoch Sets"], "AtlasLootOriginalWoW" };
