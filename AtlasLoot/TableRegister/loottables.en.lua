...
-------------------------
  ...
  -- Blackrock Depths
	AtlasLoot_TableNames["BRD"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD2"] = { "BRD Arena - Ring of Law", "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD3"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD4"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD5"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD6"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD7"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD8"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD9"] = { BabbleZone["Blackrock Depths"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["BRD10"] = { "BRD Trash", "AtlasLootProjectEpoch" };
  ...
  -- Glittermurk Mines
	...
	AtlasLoot_TableNames["Glittermurk2"] = { BabbleZone["Glittermurk Mines"], "AtlasLootProjectEpoch" };
  -- Gnomeregan
  ...
  -- Scarlet Monestery
	AtlasLoot_TableNames["SMHerod"] = { AL["Scarlet Monastery - Armory"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["SMCathedral"] = { AL["Scarlet Monastery - Cathedral"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["SMGraveyard"] = { AL["Scarlet Monastery - Graveyard"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["SMLibrary"] = { AL["Scarlet Monastery - Library"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["SMTrash"] = { AL["Scarlet Monastery - Trash"], "AtlasLootProjectEpoch" };
  -- Scholomance
  ...
  -- Sunken Temple
	AtlasLoot_TableNames["STTrollMinibosses"] = { BabbleZone["The Temple of Atal'Hakkar"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["STDreamscythe"] = { BabbleZone["The Temple of Atal'Hakkar"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["STEranikus"] = { BabbleZone["The Temple of Atal'Hakkar"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["STTrash"] = { AL["Trash Mobs"].." ("..BabbleZone["The Temple of Atal'Hakkar"]..")", "AtlasLootProjectEpoch" };
  -- Uldaman
	AtlasLoot_TableNames["UldMagreganDeepshadow"] = { "Outside Uldaman", "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["UldBaelog"] = { BabbleZone["Uldaman"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["UldObsidianSentinel"] = { BabbleZone["Uldaman"], "AtlasLootProjectEpoch" };
  ...
  -- Zul'Farrak
	AtlasLoot_TableNames["ZFAntusul"] = { BabbleZone["Zul'Farrak"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["ZFHydromancerVelratha"] = { BabbleZone["Zul'Farrak"], "AtlasLootProjectEpoch" };
...
------------
  ...
  -- T1/T2 Sets
	AtlasLoot_TableNames["T1T2Druid"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Hunter"] = { LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Mage"] = { LOCALIZED_CLASS_NAMES_MALE["MAGE"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Paladin"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Priest"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Rogue"] = { LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Shaman"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Warlock"] = { LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T1T2Warrior"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootProjectEpoch" };
  -- T3 Sets
	AtlasLoot_TableNames["T3Druid"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Hunter"] = { LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Mage"] = { LOCALIZED_CLASS_NAMES_MALE["MAGE"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Paladin"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Priest"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Rogue"] = { LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Shaman"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Warlock"] = { LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["T3Warrior"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"], "AtlasLootProjectEpoch" };
...
------------------------
  ...
  -- Tabards
	AtlasLoot_TableNames["Tabards1"] = { AL["Tabards"], "AtlasLootProjectEpoch" };
...
------------------------
  ...
  -- Misc Factions
	AtlasLoot_TableNames["MiscFactions1"] = { AL["Centaur Clans"], "AtlasLootProjectEpoch" };
	AtlasLoot_TableNames["MiscFactions3"] = { BabbleFaction["Wintersaber Trainers"], "AtlasLootProjectEpoch" };
  ...
  -- Bloodsail Buccaneers
	AtlasLoot_TableNames["Bloodsail Buccaneers"] = { BabbleFaction["Bloodsail Buccaneers"], "AtlasLootProjectEpoch" };
  -- Auberdine
...
-------------
  ...
  -- Menus, the entry does nothing, but makes the generalised loot table code less complex
	...
	AtlasLoot_TableNames["SETSCLASSIC"] = { AL["Sets"], "Menu" };
	...
	AtlasLoot_TableNames["Scarletmenu"] = { BabbleZone["Scarlet Monastery"], "Menu" };
	AtlasLoot_TableNames["Blackrock"] = { BabbleZone["Scarlet Monastery"], "Menu" };
	...
	AtlasLoot_TableNames["PVPMENU2"] = { AL["Battleground Rewards"], "Menu" };
	AtlasLoot_TableNames["WORLDEPICS"] = { AL["BoE World Epics"], "Menu" };
	AtlasLoot_TableNames["DUNGEONMENU"] = { AL["Dungeons"], "Menu" };
