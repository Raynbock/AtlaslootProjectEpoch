...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	AtlasLoot_Data["REPMENU"] = {
		...
		{ 7, "Sepulcher", "Achievement_character_undead_male", "=ds="..BabbleFaction["Sepulcher"], "=q5="..BabbleZone["Silverpine Forest"]}; 
		...
		{ 12, "Bloodsail Buccaneers", "INV_Helmet_66", "=ds="..BabbleFaction["Bloodsail Buccaneers"], "=q5="..BabbleZone["Stranglethorn Vale"]};
		...
		{ 13, "MiscFactions3", "Ability_Mount_PinkTiger", "=ds="..BabbleFaction["Wintersaber Trainers"], "=q5="..BabbleFaction["Alliance"].." - "..BabbleZone["Winterspring"]};
	};