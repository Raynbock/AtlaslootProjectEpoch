...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	AtlasLoot_Data["WORLDBOSSMENU"] = {
		...
		{ 2, "Silithidlurker", "ability_hunter_pet_silithid", "=ds="..BabbleEpoch["Silithid Lurker"], "=q5="..BabbleZone["Tanaris"]};
		{ 3, "Volchan", "spell_shaman_lavaflow", "=ds="..BabbleEpoch["Volchan"], "=q5="..BabbleZone["Burning Steppes"]};
		Back = "WORLDEVENTMENU";
	};
