...
if AL then
	...
	AL["Scarlet Monastery - Trash"] = true;
	...
	-- Dungeons
	AL["Ragefire Chasm"] = true;
	AL["Wailing Caverns"] = true;
	AL["Deadmines"] = true;
	AL["Shadowfang Keep"] = true;
	...
	AL["Zul'Farrak"] = true;
	AL["Maraudon"] = true;
	AL["Sunken Temple"] = true;
	AL["Blackrock Depths"] = true;
	AL["Blackrock Spire"] = true;
	AL["Scholomance"] = true;
	AL["Stratholme"] = true;
	AL["10"] = true;
	AL["20"] = true;
