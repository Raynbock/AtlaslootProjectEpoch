...
if AL then
	...
	-- Tooltip for the Filter checkbox
	AL["Filter Items"] = true;
    AL["Hides any items on this page"] = true;
    AL["which are excluded by your"] = true;
    AL["filter options."] = true;
    AL["Right click"] = true;
    AL["Open filter options."] = true;

	-- Help Frame
	AL["Help"] = true;
	AL["AtlasLoot Help"] = true;
	AL["For further help, visit our channel in the Epoch Addons discord: "] = true;
