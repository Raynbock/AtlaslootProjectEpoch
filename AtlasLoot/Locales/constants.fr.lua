...
if AL then
	...
	AL["For further help, visit our channel in the Epoch Addons discord: "] = "Pour obtenir de l'aide supplémentaire, visitez notre chaîne dans le discord Epoch Addons :";
