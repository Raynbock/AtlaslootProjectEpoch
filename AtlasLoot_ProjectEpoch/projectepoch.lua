...
---- Timbermaw Hold
	...
	AtlasLoot_Data["Glittermurk"] = {
		...
		{ 6, 60997, "", "=q3=Throwing ´Saws´", "", "", ""};
		{ 7, 60991, "", "=q3=Shredder Spaulders", "", "", ""};
		{ 8, 60995, "", "=q3=Steel Pickaxe", "", "", ""};
		{ 10, 0, "INV_Box_01", "=q6=???", ""};
		{ 11, 60983, "", "=q3=Faded Ring of Truestrike", "", "", ""};
		{ 12, 60981, "", "=q3=Deepsea Coral", "", "", ""};
		{ 13, 60971, "", "=q3=Aquablade", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6=Prismscale", ""};
		{ 17, 60974, "", "=q3=Chromatic Wand", "", "", ""};
		{ 18, 61002, "", "=q3=Warding Scale", "", "", ""};
		{ 20, 0, "INV_Box_01", "=q6=Murklurk", ""};
		{ 21, 61058, "", "=q3=Shadowcasters Hood", "", "", ""};
		{ 22, 60970, "", "=q3=Amulet of Brawn", "", "", ""};
		{ 24, 0, "INV_Box_01", "=q6=Gnash", ""};
		{ 25, 60987, "", "=q3=Naga Precision", "", "", ""};
		{ 26, 60980, "", "=q3=Crown of Tides", "", "", ""};
		{ 27, 60982, "", "=q3=Encrusted Fetish", "", "", ""};
		{ 28, 60973, "", "=q3=Buckler of Seas", "", "", ""};
		Back = "DUNGEONMENU";
	};
