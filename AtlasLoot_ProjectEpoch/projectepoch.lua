...
---- Timbermaw Hold
	...
	AtlasLoot_Data["WailingCaverns2"] = {
		...
		{ 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Serpentis"], ""};
		{ 6, 5970, "", "=q3=Serpent Gloves", "=ds=#s9#, #a1#", "", "20.96%"};
		{ 7, 10411, "", "=q3=Footpads of the Fang", "=ds=#s12#, #a2#", "", "19.07%"};
		{ 8, 6459, "", "=q3=Savage Trodders", "=ds=#s12#, #a3#", "", "24.39%"};
		{ 9, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "16.63%"};
		{ 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Cobrahn"], ""};
		{ 12, 6465, "", "=q3=Robe of the Moccasin", "=ds=#s5#, #a1#", "", "51.73%"};
	...
	AtlasLoot_Data["Thorium1"] = {
		...
		{ 17, 19448, "", "=q1=Formula: Enchant Weapon - Mighty Spirit", "=ds=#p4# (300)"};
		Next = "Thorium2";
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Thorium2"] = {
		...
		{ 2, 19449, "", "=q1=Formula: Enchant Weapon - Mighty Intellect", "=ds=#p4# (300)"};
		Prev = "Thorium1";
		Back = "REPMENU";
	};
