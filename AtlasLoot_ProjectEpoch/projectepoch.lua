...
---- Timbermaw Hold
	...
	AtlasLoot_Data["RazorfenDowns2"] = {
		...
		{ 11, 61159, "", "=q3=Belt of Plaguemaw", "=ds=#s9#, #a2#", "", "58.15%"};
	...
	AtlasLoot_Data["TheStockade"] = {
		...
		{ 18, 3628, "", "=q1=Hand of Dextren Ward", "=ds=#m3#", "", "100%"};
		{ 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Bruegal Ironknuckle"], ""};
		{ 21, 3228, "", "=q3=Jimmied Handcuffs", "=ds=#s8#, #a3#", "", "54.73%"};
		{ 22, 2942, "", "=q3=Iron Knuckles", "=ds=#h1#, #w13#", "", "18.18%"};
		{ 23, 2941, "", "=q3=Prison Shank", "=ds=#h1#, #w4#", "", "16.05%"};
		{ 25, 0, "INV_Box_01", "=q6=#n11#", ""};
		{ 26, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#"};
		Back = "DUNGEONMENU";
	};
	...
	AtlasLoot_Data["UldBaelog"] = {
		...
		{ 24, 9407, "", "=q3=Stoneweaver Leggings", "=ds=#s11#, #a1#", "", "31.02%"};
		{ 25, 9409, "", "=q3=Ironaya's Bracers", "=ds=#s8#, #a3# =q2=#m16#", "", "32.71%"};
		{ 26, 9408, "", "=q3=Ironshod Bludgeon", "=ds=#w9#", "", "17.37%"};
	...
	AtlasLoot_Data["UldObsidianSentinel"] = {
		...
		{ 17, 9415, "", "=q3=Grimlok's Tribal Vestments", "=ds=#s5#, #a1#", "", "36.51%"};
		{ 18, 9414, "", "=q3=Oilskin Leggings", "=ds=#s11#, #a2#", "", "29.78%"};
		{ 19, 9416, "", "=q3=Grimlok's Charge", "=ds=#w7#", "", "15.05%"};
		{ 20, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%"};
		{ 22, 0, "INV_Box_01", "=q6=Archaedas", ""};
		{ 23, 11118, "", "=q3=Archaedic Stone", "=ds=#s13# =q2=#m16#", "", "51.99%"};
		{ 24, 9418, "", "=q3=Stoneslayer", "=ds=#h2#, #w10#", "", "10.48%"};
		{ 25, 9413, "", "=q3=The Rockpounder", "=ds=#h2#, #w6#", "", "10.94%"};
		{ 26, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%"};
		Next = "UldTrash";
		Prev = "UldBaelog";
		Back = "DUNGEONMENU";
	};
