...
---- Timbermaw Hold
	...
	AtlasLoot_Data["Glittermurk"] = {
		...
		{ 4, 0, "INV_Box_01", "=q6=Miner Davod", ""};
		{ 5, 61007, "", "=q3=Davod´s Lantern", "", "", ""};
		{ 7, 0, "INV_Box_01", "=q6=Foreman Sprocket", ""};
		{ 8, 60986, "", "=q3=Heavy Metal Belt", "", "", ""};
		{ 9, 60997, "", "=q3=Throwing ´Saws´", "", "", ""};
		{ 10, 60991, "", "=q3=Shredder Spaulders", "", "", ""};
		{ 11, 60995, "", "=q3=Steel Pickaxe", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6=???", ""};
	...
	AtlasLoot_Data["Glittermurk2"] = {
		{ 1, 0, "INV_Box_01", "=q6=Murklurk", ""};
		{ 2, 61058, "", "=q3=Shadowcasters Hood", "", "", ""};
		{ 3, 60984, "", "=q3=Forgotten Shoulderpads", "", "", ""};
		{ 4, 60970, "", "=q3=Amulet of Brawn", "", "", ""};
		{ 6, 0, "INV_Box_01", "=q6=Gnash", ""};
		{ 7, 60998, "", "=q4=Trident of Nazjatar", "", "", ""};
		{ 8, 60987, "", "=q3=Naga Precision", "", "", ""};
		{ 9, 60980, "", "=q3=Crown of Tides", "", "", ""};
		{ 10, 60982, "", "=q3=Encrusted Fetish", "", "", ""};
		{ 11, 60973, "", "=q3=Buckler of Seas", "", "", ""};
		Prev = "Glittermurk";
		Back = "DUNGEONMENU";
	};
	...
	AtlasLoot_Data["RazorfenDowns1"] = {
		...
		{ 12, 61163, "", "=q3=Warmed Boots", "", "", ""};
		{ 13, 10769, "", "=q3=Glowing Eye of Mordresh", "=ds=#s2#", "", "29.11%"};
		{ 14, 10770, "", "=q3=Mordresh's Lifeless Skull", "=ds=#s15#", "", "29.59%"};
	...
	AtlasLoot_Data["RazorfenDowns2"] = {
		...
		{ 12, 61159, "", "=q3=Belt of Plaguemaw", "=ds=#s9#, #a2#", "", "58.15%"};
		{ 13, 10766, "", "=q3=Plaguerot Sprig", "=ds=#w12#, =q1=#m1# =ds=#c3#", "", "29.98%"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
	...
	AtlasLoot_Data["RazorfenKraul1"] = {
		...
		{ 6, 6681, "", "=q3=Thornspike", "=ds=#h1#, #w4#", "", "57,12%"};
		{ 5, 61084, "", "=q3=Thorn Spiked Mantle", "", "", ""};
	...
	AtlasLoot_Data["SMHerod"] = {
		...
		{ 6, 61049, "", "=q3=Berserker´s Cape", "", "", ""};
		{ 8, 0, "INV_Box_01", "=q6=#n43#", ""};
		{ 9, 23192, "", "=q2=Tabard of the Scarlet Crusade", "=ds=#s7#", "", "0.4%"};
		Next = "SMCathedral";
		Prev = "SMLibrary";
		Back = "Scarletmenu";
	};
	...
	AtlasLoot_Data["TheStockade"] = {
		...
		{ 17, 60585, "", "=q3=Warden Breastplate", "", "", ""};
		{ 18, 60582, "", "=q2=Smuggling Pouch", "", "", ""};
		...
		{ 26, 0, "INV_Box_01", "=q6=#n11#", ""};
		{ 27, 2909, "", "=q1=Red Wool Bandana", "=ds=#m3#"};
		Back = "DUNGEONMENU";
	};
	...
	AtlasLoot_Data["UldBaelog"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=Revelosh", ""};
		{ 17, 9390, "", "=q3=Revelosh's Gloves", "=ds=#s9#, #a1# =q2=#m16#", "", "20.08%"};
		{ 18, 9389, "", "=q3=Revelosh's Spaulders", "=ds=#s3#, #a2# =q2=#m16#", "", "18.77%"};
		{ 19, 9388, "", "=q3=Revelosh's Armguards", "=ds=#s8#, #a3# =q2=#m16#", "", "19.84%"};
		{ 20, 9387, "", "=q3=Revelosh's Boots", "=ds=#s12#, #a4# =q2=#m16#", "", "20.53%"};
		{ 21, 7741, "", "=q1=The Shaft of Tsol", "=ds=#m3#"};
		{ 23, 0, "INV_Box_01", "=q6=Ironaya", ""};
		{ 24, 61183, "", "Marred Uldic Hands", "", "", ""};
		{ 25, 9407, "", "=q3=Stoneweaver Leggings", "=ds=#s11#, #a1#", "", "31.02%"};
		{ 26, 9409, "", "=q3=Ironaya's Bracers", "=ds=#s8#, #a3# =q2=#m16#", "", "32.71%"};
		{ 27, 9408, "", "=q3=Ironshod Bludgeon", "=ds=#w9#", "", "17.37%"};
	...
	AtlasLoot_Data["UldObsidianSentinel"] = {
		{ 1, 0, "INV_Box_01", "=q6=Ancient Stone Keeper", ""};
		{ 2, 9411, "", "=q3=Rockshard Pauldrons", "=ds=#s3#, #a3#", "", "43.41%"};
		{ 3, 9410, "", "=q3=Cragfists", "=ds=#s9#, #a4# =q2=#m16#", "", "41.61%"};
		{ 5, 0, "INV_Box_01", "=q6=Galgann Firehammer", ""};
		{ 6, 11311, "", "=q3=Emberscale Cape", "=ds=#s4#", "", "36.52%"};
		{ 7, 11310, "", "=q3=Flameseer Mantle", "=ds=#s3#, #a1#", "", "17.35%"};
		{ 8, 9419, "", "=q3=Galgann's Firehammer", "=ds=#h1#, #w6#", "", "18.10%"};
		{ 9, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "17.10%"};
		{ 16, 0, "INV_Box_01", "=q6=Grimlok", ""};
		{ 17, 61185, "", "Marred Uldic Legplates", "", "", ""};
		{ 18, 9415, "", "=q3=Grimlok's Tribal Vestments", "=ds=#s5#, #a1#", "", "36.51%"};
		{ 19, 9414, "", "=q3=Oilskin Leggings", "=ds=#s11#, #a2#", "", "29.78%"};
		{ 20, 9416, "", "=q3=Grimlok's Charge", "=ds=#w7#", "", "15.05%"};
		{ 21, 7670, "", "=q1=Shattered Necklace Sapphire", "=ds=#m3#", "", "100%"};
		{ 23, 0, "INV_Box_01", "=q6=Archaedas", ""};
		{ 24, 61182, "", "Marred Uldic Chestplate", "", "", ""};
		{ 25, 11118, "", "=q3=Archaedic Stone", "=ds=#s13# =q2=#m16#", "", "51.99%"};
		{ 26, 9418, "", "=q3=Stoneslayer", "=ds=#h2#, #w10#", "", "10.48%"};
		{ 27, 9413, "", "=q3=The Rockpounder", "=ds=#h2#, #w6#", "", "10.94%"};
		{ 28, 7672, "", "=q1=Shattered Necklace Power Source", "=ds=#m3#", "", "100%"};
		Next = "UldTrash";
		Prev = "UldBaelog";
		Back = "DUNGEONMENU";
	};
	...
	AtlasLoot_Data["UldTrash"] = {
		...
		{ 14, 61186, "", "Marred Uldic Sabatons", ""};
