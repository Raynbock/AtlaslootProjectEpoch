...
---- Crafted Epic Weapons
	...
	AtlasLoot_Data["AlchemyMisc1"] = {
		...
		{ 21, "s11459", "9149", "=q1=Philosopher's Stone", "=ds="..AL["Vendor"]..", "..BabbleZone["Tanaris"]};
		{ 22, "s7837", "6371", "=q1=Fire Oil", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["EnchantingRing1"] = {
		{ 1, "s0", "Spell_Holy_GreaterHeal", "=ds=Under Construction", "=ds="..AL["Trainer"]};
	...
	AtlasLoot_Data["Mining1"] = {
		...
		{ 21, 2776, "", "=q2=Gold Ore", "=ds=#sr# "};
		{ 22, 2772, "", "=q1=Iron Ore", "=ds=#sr# "};
	...
	AtlasLoot_Data["TailoringMisc1"] = {
		{ 1, "s0", "0", "=q4=Enchants coming here soon", "=ds=#sr# 300"};
		Back = "TAILORINGMENU";
	};
