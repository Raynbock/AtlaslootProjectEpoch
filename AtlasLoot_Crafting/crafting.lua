...
---- Crafted Epic Weapons
	...
	AtlasLoot_Data["EnchantingWeapon1"] = {
		...
		{ 2, "s86800", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Panacea", "=ds=#sr# 300"};
		{ 3, "s86794", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Dragon's Widsom", "=ds=#sr# 300"};
		{ 4, "s20032", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Lifestealing", "=ds=#sr# 300"};
		{ 5, "s23804", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Mighty Intellect", "=ds=#sr# 300"};
		{ 6, "s23803", "Spell_Holy_GreaterHeal", "=ds=Enchant Weapon - Mighty Spirit", "=ds=#sr# 300"};
